 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ke(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Vd(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(ke())}function Od(){var n;const e=(n=Ns())===null||n===void 0?void 0:n.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function xd(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Ld(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Md(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Fd(){const n=ke();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Ud(){return!Od()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function jd(){try{return typeof indexedDB=="object"}catch{return!1}}function Bd(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{var o;e(((o=s.error)===null||o===void 0?void 0:o.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ms=new eo("@firebase/auth");function ip(n,...e){ms.logLevel<=H.WARN&&ms.warn(`Auth (${Rn}): ${n}`,...e)}function ss(n,...e){ms.logLevel<=H.ERROR&&ms.error(`Auth (${Rn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _s(n){var e;const t=n.auth,r=await n.getIdToken(),s=await gn(n,Ml(t,{idToken:r}));j(s==null?void 0:s.users.length,t,"internal-error");const o=s.users[0];n._notifyReloadListener(o);const a=!((e=o.providerUserInfo)===null||e===void 0)&&e.length?Fl(o.providerUserInfo):[],l=Ep(n.providerData,a),u=n.isAnonymous,d=!(n.email&&o.passwordHash)&&!(l!=null&&l.length),p=u?d:!1,g={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:l,metadata:new Li(o.createdAt,o.lastLoginAt),isAnonymous:p};Object.assign(n,g)}async function vp(n){const e=ge(n);await _s(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Ep(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Fl(n){return n.map(e=>{var{providerId:t}=e,r=ro(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dn{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){j(e.idToken,"internal-error"),j(typeof e.idToken<"u","internal-error"),j(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):cc(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){j(e.length!==0,"internal-error");const t=cc(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(j(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:r,refreshToken:s,expiresIn:o}=await Ip(e,t);this.updateTokensAndExpiration(r,s,Number(o))}updateTokensAndExpiration(e,t,r){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,t){const{refreshToken:r,accessToken:s,expirationTime:o}=t,a=new dn;return r&&(j(typeof r=="string","internal-error",{appName:e}),a.refreshToken=r),s&&(j(typeof s=="string","internal-error",{appName:e}),a.accessToken=s),o&&(j(typeof o=="number","internal-error",{appName:e}),a.expirationTime=o),a}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new dn,this.toJSON())}_performRefresh(){return st("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gt(n,e){j(typeof n=="string"||typeof n>"u","internal-error",{appName:e})}class it{constructor(e){var{uid:t,auth:r,stsTokenManager:s}=e,o=ro(e,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new yp(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=t,this.auth=r,this.stsTokenManager=s,this.accessToken=s.accessToken,this.displayName=o.displayName||null,this.email=o.email||null,this.emailVerified=o.emailVerified||!1,this.phoneNumber=o.phoneNumber||null,this.photoURL=o.photoURL||null,this.isAnonymous=o.isAnonymous||!1,this.tenantId=o.tenantId||null,this.providerData=o.providerData?[...o.providerData]:[],this.metadata=new Li(o.createdAt||void 0,o.lastLoginAt||void 0)}async getIdToken(e){const t=await gn(this,this.stsTokenManager.getToken(this.auth,e));return j(t,this.auth,"internal-error"),this.accessToken!==t&&(this.accessToken=t,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),t}getIdTokenResult(e){return _p(this,e)}reload(){return vp(this)}_assign(e){this!==e&&(j(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(t=>Object.assign({},t)),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const t=new it(Object.assign(Object.assign({},this),{auth:e,stsTokenManager:this.stsTokenManager._clone()}));return t.metadata._copy(this.metadata),t}_onReload(e){j(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,t=!1){let r=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),r=!0),t&&await _s(this),await this.auth._persistUserIfCurrent(this),r&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(Qe(this.auth.app))return Promise.reject(at(this.auth));const e=await this.getIdToken();return await gn(this,mp(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return Object.assign(Object.assign({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>Object.assign({},e)),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,t){var r,s,o,a,l,u,d,p;const g=(r=t.displayName)!==null&&r!==void 0?r:void 0,w=(s=t.email)!==null&&s!==void 0?s:void 0,S=(o=t.phoneNumber)!==null&&o!==void 0?o:void 0,P=(a=t.photoURL)!==null&&a!==void 0?a:void 0,N=(l=t.tenantId)!==null&&l!==void 0?l:void 0,D=(u=t._redirectEventId)!==null&&u!==void 0?u:void 0,U=(d=t.createdAt)!==null&&d!==void 0?d:void 0,x=(p=t.lastLoginAt)!==null&&p!==void 0?p:void 0,{uid:G,emailVerified:Z,isAnonymous:ie,providerData:te,stsTokenManager:T}=t;j(G&&T,e,"internal-error");const m=dn.fromJSON(this.name,T);j(typeof G=="string",e,"internal-error"),gt(g,e.name),gt(w,e.name),j(typeof Z=="boolean",e,"internal-error"),j(typeof ie=="boolean",e,"internal-error"),gt(S,e.name),gt(P,e.name),gt(N,e.name),gt(D,e.name),gt(U,e.name),gt(x,e.name);const y=new it({uid:G,auth:e,email:w,emailVerified:Z,displayName:g,isAnonymous:ie,photoURL:P,phoneNumber:S,tenantId:N,stsTokenManager:m,createdAt:U,lastLoginAt:x});return te&&Array.isArray(te)&&(y.providerData=te.map(E=>Object.assign({},E))),D&&(y._redirectEventId=D),y}static async _fromIdTokenResponse(e,t,r=!1){const s=new dn;s.updateFromServerResponse(t);const o=new it({uid:t.localId,auth:e,stsTokenManager:s,isAnonymous:r});return await _s(o),o}static async _fromGetAccountInfoResponse(e,t,r){const s=t.users[0];j(s.localId!==void 0,"internal-error");const o=s.providerUserInfo!==void 0?Fl(s.providerUserInfo):[],a=!(s.email&&s.passwordHash)&&!(o!=null&&o.length),l=new dn;l.updateFromIdToken(r);const u=new it({uid:s.localId,auth:e,stsTokenManager:l,isAnonymous:a}),d={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:o,metadata:new Li(s.createdAt,s.lastLoginAt),isAnonymous:!(s.email&&s.passwordHash)&&!(o!=null&&o.length)};return Object.assign(u,d),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hc(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(ql(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(jl(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Wl(e))return"Blackberry";if(Gl(e))return"Webos";if(Bl(e))return"Safari";if((e.includes("chrome/")||$l(e))&&!e.includes("edge/"))return"Chrome";if(zl(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function jl(n=ke()){return/firefox\//i.test(n)}function Bl(n=ke()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function $l(n=ke()){return/crios\//i.test(n)}function ql(n=ke()){return/iemobile/i.test(n)}function zl(n=ke()){return/android/i.test(n)}function Wl(n=ke()){return/blackberry/i.test(n)}function Gl(n=ke()){return/webos/i.test(n)}function ao(n=ke()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function wp(n=ke()){var e;return ao(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Ap(){return Fd()&&document.documentMode===10}function Hl(n=ke()){return ao(n)||zl(n)||Gl(n)||Wl(n)||/windows phone/i.test(n)||ql(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kl(n,e=[]){let t;switch(n){case"Browser":t=hc(ke());break;case"Worker":t=`${hc(ke())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Rn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mp(n,e){const t=no(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),o=t.getOptions();if(dr(o,e??{}))return s;We(s,"already-initialized")}return t.initialize({options:e})}function Fp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(ot);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Up(n,e,t){const r=kt(n);j(r._canInitEmulator,r,"emulator-config-failed"),j(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,o=Xl(e),{host:a,port:l}=jp(e),u=l===null?"":`:${l}`;r.config.emulator={url:`${o}//${a}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:l,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})}),Bp()}function Xl(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function jp(n){const e=Xl(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const o=s[1];return{host:o,port:pc(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:pc(a)}}}function pc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Bp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qp(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Xp(n){const e=tr(nr(n)).link,t=e?tr(nr(e)).deep_link_id:null,r=tr(nr(n)).deep_link_id;return(r?tr(nr(r)).link:null)||r||t||e||n}class lo{constructor(e){var t,r,s,o,a,l;const u=tr(nr(e)),d=(t=u.apiKey)!==null&&t!==void 0?t:null,p=(r=u.oobCode)!==null&&r!==void 0?r:null,g=Qp((s=u.mode)!==null&&s!==void 0?s:null);j(d&&p&&g,"argument-error"),this.apiKey=d,this.operation=g,this.code=p,this.continueUrl=(o=u.continueUrl)!==null&&o!==void 0?o:null,this.languageCode=(a=u.languageCode)!==null&&a!==void 0?a:null,this.tenantId=(l=u.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const t=Xp(e);try{return new lo(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bn{constructor(){this.providerId=bn.PROVIDER_ID}static credential(e,t){return pr._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=lo.parseLink(t);return j(r,"argument-error"),pr._fromEmailAndCode(e,r.code,r.tenantId)}}bn.PROVIDER_ID="password";bn.EMAIL_PASSWORD_SIGN_IN_METHOD="password";bn.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function im(n,{displayName:e,photoURL:t}){if(e===void 0&&t===void 0)return;const r=ge(n),o={idToken:await r.getIdToken(),displayName:e,photoUrl:t,returnSecureToken:!0},a=await gn(r,sm(r.auth,o));r.displayName=a.displayName||null,r.photoURL=a.photoUrl||null;const l=r.providerData.find(({providerId:u})=>u==="password");l&&(l.displayName=r.displayName,l.photoURL=r.photoURL),await r._updateTokensIfNecessary(a)}function om(n,e,t,r){return ge(n).onIdTokenChanged(e,t,r)}function am(n,e,t){return ge(n).beforeAuthStateChanged(e,t)}function cm(n,e,t,r){return ge(n).onAuthStateChanged(e,t,r)}function lm(n){return ge(n).signOut()}const vs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rm(n,e){return e?ot(e):(j(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var $t,hu;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,m){function y(){}y.prototype=m.prototype,T.D=m.prototype,T.prototype=new y,T.prototype.constructor=T,T.C=function(E,I,R){for(var _=Array(arguments.length-2),$e=2;$e<arguments.length;$e++)_[$e-2]=arguments[$e];return m.prototype[I].apply(E,_)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(T,m,y){y||(y=0);var E=Array(16);if(typeof m=="string")for(var I=0;16>I;++I)E[I]=m.charCodeAt(y++)|m.charCodeAt(y++)<<8|m.charCodeAt(y++)<<16|m.charCodeAt(y++)<<24;else for(I=0;16>I;++I)E[I]=m[y++]|m[y++]<<8|m[y++]<<16|m[y++]<<24;m=T.g[0],y=T.g[1],I=T.g[2];var R=T.g[3],_=m+(R^y&(I^R))+E[0]+3614090360&4294967295;m=y+(_<<7&4294967295|_>>>25),_=R+(I^m&(y^I))+E[1]+3905402710&4294967295,R=m+(_<<12&4294967295|_>>>20),_=I+(y^R&(m^y))+E[2]+606105819&4294967295,I=R+(_<<17&4294967295|_>>>15),_=y+(m^I&(R^m))+E[3]+3250441966&4294967295,y=I+(_<<22&4294967295|_>>>10),_=m+(R^y&(I^R))+E[4]+4118548399&4294967295,m=y+(_<<7&4294967295|_>>>25),_=R+(I^m&(y^I))+E[5]+1200080426&4294967295,R=m+(_<<12&4294967295|_>>>20),_=I+(y^R&(m^y))+E[6]+2821735955&4294967295,I=R+(_<<17&4294967295|_>>>15),_=y+(m^I&(R^m))+E[7]+4249261313&4294967295,y=I+(_<<22&4294967295|_>>>10),_=m+(R^y&(I^R))+E[8]+1770035416&4294967295,m=y+(_<<7&4294967295|_>>>25),_=R+(I^m&(y^I))+E[9]+2336552879&4294967295,R=m+(_<<12&4294967295|_>>>20),_=I+(y^R&(m^y))+E[10]+4294925233&4294967295,I=R+(_<<17&4294967295|_>>>15),_=y+(m^I&(R^m))+E[11]+2304563134&4294967295,y=I+(_<<22&4294967295|_>>>10),_=m+(R^y&(I^R))+E[12]+1804603682&4294967295,m=y+(_<<7&4294967295|_>>>25),_=R+(I^m&(y^I))+E[13]+4254626195&4294967295,R=m+(_<<12&4294967295|_>>>20),_=I+(y^R&(m^y))+E[14]+2792965006&4294967295,I=R+(_<<17&4294967295|_>>>15),_=y+(m^I&(R^m))+E[15]+1236535329&4294967295,y=I+(_<<22&4294967295|_>>>10),_=m+(I^R&(y^I))+E[1]+4129170786&4294967295,m=y+(_<<5&4294967295|_>>>27),_=R+(y^I&(m^y))+E[6]+3225465664&4294967295,R=m+(_<<9&4294967295|_>>>23),_=I+(m^y&(R^m))+E[11]+643717713&4294967295,I=R+(_<<14&4294967295|_>>>18),_=y+(R^m&(I^R))+E[0]+3921069994&4294967295,y=I+(_<<20&4294967295|_>>>12),_=m+(I^R&(y^I))+E[5]+3593408605&4294967295,m=y+(_<<5&4294967295|_>>>27),_=R+(y^I&(m^y))+E[10]+38016083&4294967295,R=m+(_<<9&4294967295|_>>>23),_=I+(m^y&(R^m))+E[15]+3634488961&4294967295,I=R+(_<<14&4294967295|_>>>18),_=y+(R^m&(I^R))+E[4]+3889429448&4294967295,y=I+(_<<20&4294967295|_>>>12),_=m+(I^R&(y^I))+E[9]+568446438&4294967295,m=y+(_<<5&4294967295|_>>>27),_=R+(y^I&(m^y))+E[14]+3275163606&4294967295,R=m+(_<<9&4294967295|_>>>23),_=I+(m^y&(R^m))+E[3]+4107603335&4294967295,I=R+(_<<14&4294967295|_>>>18),_=y+(R^m&(I^R))+E[8]+1163531501&4294967295,y=I+(_<<20&4294967295|_>>>12),_=m+(I^R&(y^I))+E[13]+2850285829&4294967295,m=y+(_<<5&4294967295|_>>>27),_=R+(y^I&(m^y))+E[2]+4243563512&4294967295,R=m+(_<<9&4294967295|_>>>23),_=I+(m^y&(R^m))+E[7]+1735328473&4294967295,I=R+(_<<14&4294967295|_>>>18),_=y+(R^m&(I^R))+E[12]+2368359562&4294967295,y=I+(_<<20&4294967295|_>>>12),_=m+(y^I^R)+E[5]+4294588738&4294967295,m=y+(_<<4&4294967295|_>>>28),_=R+(m^y^I)+E[8]+2272392833&4294967295,R=m+(_<<11&4294967295|_>>>21),_=I+(R^m^y)+E[11]+1839030562&4294967295,I=R+(_<<16&4294967295|_>>>16),_=y+(I^R^m)+E[14]+4259657740&4294967295,y=I+(_<<23&4294967295|_>>>9),_=m+(y^I^R)+E[1]+2763975236&4294967295,m=y+(_<<4&4294967295|_>>>28),_=R+(m^y^I)+E[4]+1272893353&4294967295,R=m+(_<<11&4294967295|_>>>21),_=I+(R^m^y)+E[7]+4139469664&4294967295,I=R+(_<<16&4294967295|_>>>16),_=y+(I^R^m)+E[10]+3200236656&4294967295,y=I+(_<<23&4294967295|_>>>9),_=m+(y^I^R)+E[13]+681279174&4294967295,m=y+(_<<4&4294967295|_>>>28),_=R+(m^y^I)+E[0]+3936430074&4294967295,R=m+(_<<11&4294967295|_>>>21),_=I+(R^m^y)+E[3]+3572445317&4294967295,I=R+(_<<16&4294967295|_>>>16),_=y+(I^R^m)+E[6]+76029189&4294967295,y=I+(_<<23&4294967295|_>>>9),_=m+(y^I^R)+E[9]+3654602809&4294967295,m=y+(_<<4&4294967295|_>>>28),_=R+(m^y^I)+E[12]+3873151461&4294967295,R=m+(_<<11&4294967295|_>>>21),_=I+(R^m^y)+E[15]+530742520&4294967295,I=R+(_<<16&4294967295|_>>>16),_=y+(I^R^m)+E[2]+3299628645&4294967295,y=I+(_<<23&4294967295|_>>>9),_=m+(I^(y|~R))+E[0]+4096336452&4294967295,m=y+(_<<6&4294967295|_>>>26),_=R+(y^(m|~I))+E[7]+1126891415&4294967295,R=m+(_<<10&4294967295|_>>>22),_=I+(m^(R|~y))+E[14]+2878612391&4294967295,I=R+(_<<15&4294967295|_>>>17),_=y+(R^(I|~m))+E[5]+4237533241&4294967295,y=I+(_<<21&4294967295|_>>>11),_=m+(I^(y|~R))+E[12]+1700485571&4294967295,m=y+(_<<6&4294967295|_>>>26),_=R+(y^(m|~I))+E[3]+2399980690&4294967295,R=m+(_<<10&4294967295|_>>>22),_=I+(m^(R|~y))+E[10]+4293915773&4294967295,I=R+(_<<15&4294967295|_>>>17),_=y+(R^(I|~m))+E[1]+2240044497&4294967295,y=I+(_<<21&4294967295|_>>>11),_=m+(I^(y|~R))+E[8]+1873313359&4294967295,m=y+(_<<6&4294967295|_>>>26),_=R+(y^(m|~I))+E[15]+4264355552&4294967295,R=m+(_<<10&4294967295|_>>>22),_=I+(m^(R|~y))+E[6]+2734768916&4294967295,I=R+(_<<15&4294967295|_>>>17),_=y+(R^(I|~m))+E[13]+1309151649&4294967295,y=I+(_<<21&4294967295|_>>>11),_=m+(I^(y|~R))+E[4]+4149444226&4294967295,m=y+(_<<6&4294967295|_>>>26),_=R+(y^(m|~I))+E[11]+3174756917&4294967295,R=m+(_<<10&4294967295|_>>>22),_=I+(m^(R|~y))+E[2]+718787259&4294967295,I=R+(_<<15&4294967295|_>>>17),_=y+(R^(I|~m))+E[9]+3951481745&4294967295,T.g[0]=T.g[0]+m&4294967295,T.g[1]=T.g[1]+(I+(_<<21&4294967295|_>>>11))&4294967295,T.g[2]=T.g[2]+I&4294967295,T.g[3]=T.g[3]+R&4294967295}r.prototype.u=function(T,m){m===void 0&&(m=T.length);for(var y=m-this.blockSize,E=this.B,I=this.h,R=0;R<m;){if(I==0)for(;R<=y;)s(this,T,R),R+=this.blockSize;if(typeof T=="string"){for(;R<m;)if(E[I++]=T.charCodeAt(R++),I==this.blockSize){s(this,E),I=0;break}}else for(;R<m;)if(E[I++]=T[R++],I==this.blockSize){s(this,E),I=0;break}}this.h=I,this.o+=m},r.prototype.v=function(){var T=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);T[0]=128;for(var m=1;m<T.length-8;++m)T[m]=0;var y=8*this.o;for(m=T.length-8;m<T.length;++m)T[m]=y&255,y/=256;for(this.u(T),T=Array(16),m=y=0;4>m;++m)for(var E=0;32>E;E+=8)T[y++]=this.g[m]>>>E&255;return T};function o(T,m){var y=l;return Object.prototype.hasOwnProperty.call(y,T)?y[T]:y[T]=m(T)}function a(T,m){this.h=m;for(var y=[],E=!0,I=T.length-1;0<=I;I--){var R=T[I]|0;E&&R==m||(y[I]=R,E=!1)}this.g=y}var l={};function u(T){return-128<=T&&128>T?o(T,function(m){return new a([m|0],0>m?-1:0)}):new a([T|0],0>T?-1:0)}function d(T){if(isNaN(T)||!isFinite(T))return g;if(0>T)return D(d(-T));for(var m=[],y=1,E=0;T>=y;E++)m[E]=T/y|0,y*=4294967296;return new a(m,0)}function p(T,m){if(T.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(T.charAt(0)=="-")return D(p(T.substring(1),m));if(0<=T.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=d(Math.pow(m,8)),E=g,I=0;I<T.length;I+=8){var R=Math.min(8,T.length-I),_=parseInt(T.substring(I,I+R),m);8>R?(R=d(Math.pow(m,R)),E=E.j(R).add(d(_))):(E=E.j(y),E=E.add(d(_)))}return E}var g=u(0),w=u(1),S=u(16777216);n=a.prototype,n.m=function(){if(N(this))return-D(this).m();for(var T=0,m=1,y=0;y<this.g.length;y++){var E=this.i(y);T+=(0<=E?E:4294967296+E)*m,m*=4294967296}return T},n.toString=function(T){if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(P(this))return"0";if(N(this))return"-"+D(this).toString(T);for(var m=d(Math.pow(T,6)),y=this,E="";;){var I=Z(y,m).g;y=U(y,I.j(m));var R=((0<y.g.length?y.g[0]:y.h)>>>0).toString(T);if(y=I,P(y))return R+E;for(;6>R.length;)R="0"+R;E=R+E}},n.i=function(T){return 0>T?0:T<this.g.length?this.g[T]:this.h};function P(T){if(T.h!=0)return!1;for(var m=0;m<T.g.length;m++)if(T.g[m]!=0)return!1;return!0}function N(T){return T.h==-1}n.l=function(T){return T=U(this,T),N(T)?-1:P(T)?0:1};function D(T){for(var m=T.g.length,y=[],E=0;E<m;E++)y[E]=~T.g[E];return new a(y,~T.h).add(w)}n.abs=function(){return N(this)?D(this):this},n.add=function(T){for(var m=Math.max(this.g.length,T.g.length),y=[],E=0,I=0;I<=m;I++){var R=E+(this.i(I)&65535)+(T.i(I)&65535),_=(R>>>16)+(this.i(I)>>>16)+(T.i(I)>>>16);E=_>>>16,R&=65535,_&=65535,y[I]=_<<16|R}return new a(y,y[y.length-1]&-2147483648?-1:0)};function U(T,m){return T.add(D(m))}n.j=function(T){if(P(this)||P(T))return g;if(N(this))return N(T)?D(this).j(D(T)):D(D(this).j(T));if(N(T))return D(this.j(D(T)));if(0>this.l(S)&&0>T.l(S))return d(this.m()*T.m());for(var m=this.g.length+T.g.length,y=[],E=0;E<2*m;E++)y[E]=0;for(E=0;E<this.g.length;E++)for(var I=0;I<T.g.length;I++){var R=this.i(E)>>>16,_=this.i(E)&65535,$e=T.i(I)>>>16,Dt=T.i(I)&65535;y[2*E+2*I]+=_*Dt,x(y,2*E+2*I),y[2*E+2*I+1]+=R*Dt,x(y,2*E+2*I+1),y[2*E+2*I+1]+=_*$e,x(y,2*E+2*I+1),y[2*E+2*I+2]+=R*$e,x(y,2*E+2*I+2)}for(E=0;E<m;E++)y[E]=y[2*E+1]<<16|y[2*E];for(E=m;E<2*m;E++)y[E]=0;return new a(y,0)};function x(T,m){for(;(T[m]&65535)!=T[m];)T[m+1]+=T[m]>>>16,T[m]&=65535,m++}function G(T,m){this.g=T,this.h=m}function Z(T,m){if(P(m))throw Error("division by zero");if(P(T))return new G(g,g);if(N(T))return m=Z(D(T),m),new G(D(m.g),D(m.h));if(N(m))return m=Z(T,D(m)),new G(D(m.g),m.h);if(30<T.g.length){if(N(T)||N(m))throw Error("slowDivide_ only works with positive integers.");for(var y=w,E=m;0>=E.l(T);)y=ie(y),E=ie(E);var I=te(y,1),R=te(E,1);for(E=te(E,2),y=te(y,2);!P(E);){var _=R.add(E);0>=_.l(T)&&(I=I.add(y),R=_),E=te(E,1),y=te(y,1)}return m=U(T,I.j(m)),new G(I,m)}for(I=g;0<=T.l(m);){for(y=Math.max(1,Math.floor(T.m()/m.m())),E=Math.ceil(Math.log(y)/Math.LN2),E=48>=E?1:Math.pow(2,E-48),R=d(y),_=R.j(m);N(_)||0<_.l(T);)y-=E,R=d(y),_=R.j(m);P(R)&&(R=w),I=I.add(R),T=U(T,_)}return new G(I,T)}n.A=function(T){return Z(this,T).h},n.and=function(T){for(var m=Math.max(this.g.length,T.g.length),y=[],E=0;E<m;E++)y[E]=this.i(E)&T.i(E);return new a(y,this.h&T.h)},n.or=function(T){for(var m=Math.max(this.g.length,T.g.length),y=[],E=0;E<m;E++)y[E]=this.i(E)|T.i(E);return new a(y,this.h|T.h)},n.xor=function(T){for(var m=Math.max(this.g.length,T.g.length),y=[],E=0;E<m;E++)y[E]=this.i(E)^T.i(E);return new a(y,this.h^T.h)};function ie(T){for(var m=T.g.length+1,y=[],E=0;E<m;E++)y[E]=T.i(E)<<1|T.i(E-1)>>>31;return new a(y,T.h)}function te(T,m){var y=m>>5;m%=32;for(var E=T.g.length-y,I=[],R=0;R<E;R++)I[R]=0<m?T.i(R+y)>>>m|T.i(R+y+1)<<32-m:T.i(R+y);return new a(I,T.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,hu=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=p,$t=a}).apply(typeof Rc<"u"?Rc:typeof self<"u"?self:typeof window<"u"?window:{});var es=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var du,rr,fu,cs,Fi,pu,mu,_u;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(i,c,h){return i==Array.prototype||i==Object.prototype||(i[c]=h.value),i};function t(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof es=="object"&&es];for(var c=0;c<i.length;++c){var h=i[c];if(h&&h.Math==Math)return h}throw Error("Cannot find global object")}var r=t(this);function s(i,c){if(c)e:{var h=r;i=i.split(".");for(var f=0;f<i.length-1;f++){var A=i[f];if(!(A in h))break e;h=h[A]}i=i[i.length-1],f=h[i],c=c(f),c!=f&&c!=null&&e(h,i,{configurable:!0,writable:!0,value:c})}}function o(i,c){i instanceof String&&(i+="");var h=0,f=!1,A={next:function(){if(!f&&h<i.length){var b=h++;return{value:c(b,i[b]),done:!1}}return f=!0,{done:!0,value:void 0}}};return A[Symbol.iterator]=function(){return A},A}s("Array.prototype.values",function(i){return i||function(){return o(this,function(c,h){return h})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},l=this||self;function u(i){var c=typeof i;return c=c!="object"?c:i?Array.isArray(i)?"array":c:"null",c=="array"||c=="object"&&typeof i.length=="number"}function d(i){var c=typeof i;return c=="object"&&i!=null||c=="function"}function p(i,c,h){return i.call.apply(i.bind,arguments)}function g(i,c,h){if(!i)throw Error();if(2<arguments.length){var f=Array.prototype.slice.call(arguments,2);return function(){var A=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(A,f),i.apply(c,A)}}return function(){return i.apply(c,arguments)}}function w(i,c,h){return w=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?p:g,w.apply(null,arguments)}function S(i,c){var h=Array.prototype.slice.call(arguments,1);return function(){var f=h.slice();return f.push.apply(f,arguments),i.apply(this,f)}}function P(i,c){function h(){}h.prototype=c.prototype,i.aa=c.prototype,i.prototype=new h,i.prototype.constructor=i,i.Qb=function(f,A,b){for(var O=Array(arguments.length-2),ee=2;ee<arguments.length;ee++)O[ee-2]=arguments[ee];return c.prototype[A].apply(f,O)}}function N(i){const c=i.length;if(0<c){const h=Array(c);for(let f=0;f<c;f++)h[f]=i[f];return h}return[]}function D(i,c){for(let h=1;h<arguments.length;h++){const f=arguments[h];if(u(f)){const A=i.length||0,b=f.length||0;i.length=A+b;for(let O=0;O<b;O++)i[A+O]=f[O]}else i.push(f)}}class U{constructor(c,h){this.i=c,this.j=h,this.h=0,this.g=null}get(){let c;return 0<this.h?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function x(i){return/^[\s\xa0]*$/.test(i)}function G(){var i=l.navigator;return i&&(i=i.userAgent)?i:""}function Z(i){return Z[" "](i),i}Z[" "]=function(){};var ie=G().indexOf("Gecko")!=-1&&!(G().toLowerCase().indexOf("webkit")!=-1&&G().indexOf("Edge")==-1)&&!(G().indexOf("Trident")!=-1||G().indexOf("MSIE")!=-1)&&G().indexOf("Edge")==-1;function te(i,c,h){for(const f in i)c.call(h,i[f],f,i)}function T(i,c){for(const h in i)c.call(void 0,i[h],h,i)}function m(i){const c={};for(const h in i)c[h]=i[h];return c}const y="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function E(i,c){let h,f;for(let A=1;A<arguments.length;A++){f=arguments[A];for(h in f)i[h]=f[h];for(let b=0;b<y.length;b++)h=y[b],Object.prototype.hasOwnProperty.call(f,h)&&(i[h]=f[h])}}function I(i){var c=1;i=i.split(":");const h=[];for(;0<c&&i.length;)h.push(i.shift()),c--;return i.length&&h.push(i.join(":")),h}function R(i){l.setTimeout(()=>{throw i},0)}function _(){var i=Nn;let c=null;return i.g&&(c=i.g,i.g=i.g.next,i.g||(i.h=null),c.next=null),c}class $e{constructor(){this.h=this.g=null}add(c,h){const f=Dt.get();f.set(c,h),this.h?this.h.next=f:this.g=f,this.h=f}}var Dt=new U(()=>new Oe,i=>i.reset());class Oe{constructor(){this.next=this.g=this.h=null}set(c,h){this.h=c,this.g=h,this.next=null}reset(){this.next=this.g=this.h=null}}let Ue,xe=!1,Nn=new $e,He=()=>{const i=l.Promise.resolve(void 0);Ue=()=>{i.then(Hs)}};var Hs=()=>{for(var i;i=_();){try{i.h.call(i.g)}catch(h){R(h)}var c=Dt;c.j(i),100>c.h&&(c.h++,i.next=c.g,c.g=i)}xe=!1};function Ke(){this.s=this.s,this.C=this.C}Ke.prototype.s=!1,Ke.prototype.ma=function(){this.s||(this.s=!0,this.N())},Ke.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ye(i,c){this.type=i,this.g=this.target=c,this.defaultPrevented=!1}ye.prototype.h=function(){this.defaultPrevented=!0};var Ks=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var i=!1,c=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const h=()=>{};l.addEventListener("test",h,c),l.removeEventListener("test",h,c)}catch{}return i}();function Vt(i,c){if(ye.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i){var h=this.type=i.type,f=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;if(this.target=i.target||i.srcElement,this.g=c,c=i.relatedTarget){if(ie){e:{try{Z(c.nodeName);var A=!0;break e}catch{}A=!1}A||(c=null)}}else h=="mouseover"?c=i.fromElement:h=="mouseout"&&(c=i.toElement);this.relatedTarget=c,f?(this.clientX=f.clientX!==void 0?f.clientX:f.pageX,this.clientY=f.clientY!==void 0?f.clientY:f.pageY,this.screenX=f.screenX||0,this.screenY=f.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=typeof i.pointerType=="string"?i.pointerType:Qs[i.pointerType]||"",this.state=i.state,this.i=i,i.defaultPrevented&&Vt.aa.h.call(this)}}P(Vt,ye);var Qs={2:"touch",3:"pen",4:"mouse"};Vt.prototype.h=function(){Vt.aa.h.call(this);var i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var tn="closure_listenable_"+(1e6*Math.random()|0),Xs=0;function Ys(i,c,h,f,A){this.listener=i,this.proxy=null,this.src=c,this.type=h,this.capture=!!f,this.ha=A,this.key=++Xs,this.da=this.fa=!1}function nn(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function Ot(i){this.src=i,this.g={},this.h=0}Ot.prototype.add=function(i,c,h,f,A){var b=i.toString();i=this.g[b],i||(i=this.g[b]=[],this.h++);var O=Vn(i,c,f,A);return-1<O?(c=i[O],h||(c.fa=!1)):(c=new Ys(c,this.src,b,!!f,A),c.fa=h,i.push(c)),c};function Dn(i,c){var h=c.type;if(h in i.g){var f=i.g[h],A=Array.prototype.indexOf.call(f,c,void 0),b;(b=0<=A)&&Array.prototype.splice.call(f,A,1),b&&(nn(c),i.g[h].length==0&&(delete i.g[h],i.h--))}}function Vn(i,c,h,f){for(var A=0;A<i.length;++A){var b=i[A];if(!b.da&&b.listener==c&&b.capture==!!h&&b.ha==f)return A}return-1}var On="closure_lm_"+(1e6*Math.random()|0),xn={};function Lr(i,c,h,f,A){if(Array.isArray(c)){for(var b=0;b<c.length;b++)Lr(i,c[b],h,f,A);return null}return h=Jo(h),i&&i[tn]?i.K(c,h,d(f)?!!f.capture:!1,A):B(i,c,h,!1,f,A)}function B(i,c,h,f,A,b){if(!c)throw Error("Invalid event type");var O=d(A)?!!A.capture:!!A,ee=Js(i);if(ee||(i[On]=ee=new Ot(i)),h=ee.add(c,h,f,O,b),h.proxy)return h;if(f=ue(),h.proxy=f,f.src=i,f.listener=h,i.addEventListener)Ks||(A=O),A===void 0&&(A=!1),i.addEventListener(c.toString(),f,A);else if(i.attachEvent)i.attachEvent(Yo(c.toString()),f);else if(i.addListener&&i.removeListener)i.addListener(f);else throw Error("addEventListener and attachEvent are unavailable.");return h}function ue(){function i(h){return c.call(i.src,i.listener,h)}const c=Bh;return i}function Ne(i,c,h,f,A){if(Array.isArray(c))for(var b=0;b<c.length;b++)Ne(i,c[b],h,f,A);else f=d(f)?!!f.capture:!!f,h=Jo(h),i&&i[tn]?(i=i.i,c=String(c).toString(),c in i.g&&(b=i.g[c],h=Vn(b,h,f,A),-1<h&&(nn(b[h]),Array.prototype.splice.call(b,h,1),b.length==0&&(delete i.g[c],i.h--)))):i&&(i=Js(i))&&(c=i.g[c.toString()],i=-1,c&&(i=Vn(c,h,f,A)),(h=-1<i?c[i]:null)&&Ln(h))}function Ln(i){if(typeof i!="number"&&i&&!i.da){var c=i.src;if(c&&c[tn])Dn(c.i,i);else{var h=i.type,f=i.proxy;c.removeEventListener?c.removeEventListener(h,f,i.capture):c.detachEvent?c.detachEvent(Yo(h),f):c.addListener&&c.removeListener&&c.removeListener(f),(h=Js(c))?(Dn(h,i),h.h==0&&(h.src=null,c[On]=null)):nn(i)}}}function Yo(i){return i in xn?xn[i]:xn[i]="on"+i}function Bh(i,c){if(i.da)i=!0;else{c=new Vt(c,this);var h=i.listener,f=i.ha||i.src;i.fa&&Ln(i),i=h.call(f,c)}return i}function Js(i){return i=i[On],i instanceof Ot?i:null}var Zs="__closure_events_fn_"+(1e9*Math.random()>>>0);function Jo(i){return typeof i=="function"?i:(i[Zs]||(i[Zs]=function(c){return i.handleEvent(c)}),i[Zs])}function Re(){Ke.call(this),this.i=new Ot(this),this.M=this,this.F=null}P(Re,Ke),Re.prototype[tn]=!0,Re.prototype.removeEventListener=function(i,c,h,f){Ne(this,i,c,h,f)};function De(i,c){var h,f=i.F;if(f)for(h=[];f;f=f.F)h.push(f);if(i=i.M,f=c.type||c,typeof c=="string")c=new ye(c,i);else if(c instanceof ye)c.target=c.target||i;else{var A=c;c=new ye(f,i),E(c,A)}if(A=!0,h)for(var b=h.length-1;0<=b;b--){var O=c.g=h[b];A=Mr(O,f,!0,c)&&A}if(O=c.g=i,A=Mr(O,f,!0,c)&&A,A=Mr(O,f,!1,c)&&A,h)for(b=0;b<h.length;b++)O=c.g=h[b],A=Mr(O,f,!1,c)&&A}Re.prototype.N=function(){if(Re.aa.N.call(this),this.i){var i=this.i,c;for(c in i.g){for(var h=i.g[c],f=0;f<h.length;f++)nn(h[f]);delete i.g[c],i.h--}}this.F=null},Re.prototype.K=function(i,c,h,f){return this.i.add(String(i),c,!1,h,f)},Re.prototype.L=function(i,c,h,f){return this.i.add(String(i),c,!0,h,f)};function Mr(i,c,h,f){if(c=i.i.g[String(c)],!c)return!0;c=c.concat();for(var A=!0,b=0;b<c.length;++b){var O=c[b];if(O&&!O.da&&O.capture==h){var ee=O.listener,Ee=O.ha||O.src;O.fa&&Dn(i.i,O),A=ee.call(Ee,f)!==!1&&A}}return A&&!f.defaultPrevented}function Zo(i,c,h){if(typeof i=="function")h&&(i=w(i,h));else if(i&&typeof i.handleEvent=="function")i=w(i.handleEvent,i);else throw Error("Invalid listener argument");return 2147483647<Number(c)?-1:l.setTimeout(i,c||0)}function ea(i){i.g=Zo(()=>{i.g=null,i.i&&(i.i=!1,ea(i))},i.l);const c=i.h;i.h=null,i.m.apply(null,c)}class $h extends Ke{constructor(c,h){super(),this.m=c,this.l=h,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:ea(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Mn(i){Ke.call(this),this.h=i,this.g={}}P(Mn,Ke);var ta=[];function na(i){te(i.g,function(c,h){this.g.hasOwnProperty(h)&&Ln(c)},i),i.g={}}Mn.prototype.N=function(){Mn.aa.N.call(this),na(this)},Mn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ei=l.JSON.stringify,qh=l.JSON.parse,zh=class{stringify(i){return l.JSON.stringify(i,void 0)}parse(i){return l.JSON.parse(i,void 0)}};function ti(){}ti.prototype.h=null;function ra(i){return i.h||(i.h=i.i())}function sa(){}var Fn={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function ni(){ye.call(this,"d")}P(ni,ye);function ri(){ye.call(this,"c")}P(ri,ye);var xt={},ia=null;function Fr(){return ia=ia||new Re}xt.La="serverreachability";function oa(i){ye.call(this,xt.La,i)}P(oa,ye);function Un(i){const c=Fr();De(c,new oa(c))}xt.STAT_EVENT="statevent";function aa(i,c){ye.call(this,xt.STAT_EVENT,i),this.stat=c}P(aa,ye);function Ve(i){const c=Fr();De(c,new aa(c,i))}xt.Ma="timingevent";function ca(i,c){ye.call(this,xt.Ma,i),this.size=c}P(ca,ye);function jn(i,c){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){i()},c)}function Bn(){this.g=!0}Bn.prototype.xa=function(){this.g=!1};function Wh(i,c,h,f,A,b){i.info(function(){if(i.g)if(b)for(var O="",ee=b.split("&"),Ee=0;Ee<ee.length;Ee++){var Q=ee[Ee].split("=");if(1<Q.length){var be=Q[0];Q=Q[1];var Se=be.split("_");O=2<=Se.length&&Se[1]=="type"?O+(be+"="+Q+"&"):O+(be+"=redacted&")}}else O=null;else O=b;return"XMLHTTP REQ ("+f+") [attempt "+A+"]: "+c+`
`+h+`
`+O})}function Gh(i,c,h,f,A,b,O){i.info(function(){return"XMLHTTP RESP ("+f+") [ attempt "+A+"]: "+c+`
`+h+`
`+b+" "+O})}function rn(i,c,h,f){i.info(function(){return"XMLHTTP TEXT ("+c+"): "+Kh(i,h)+(f?" "+f:"")})}function Hh(i,c){i.info(function(){return"TIMEOUT: "+c})}Bn.prototype.info=function(){};function Kh(i,c){if(!i.g)return c;if(!c)return null;try{var h=JSON.parse(c);if(h){for(i=0;i<h.length;i++)if(Array.isArray(h[i])){var f=h[i];if(!(2>f.length)){var A=f[1];if(Array.isArray(A)&&!(1>A.length)){var b=A[0];if(b!="noop"&&b!="stop"&&b!="close")for(var O=1;O<A.length;O++)A[O]=""}}}}return ei(h)}catch{return c}}var Ur={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},la={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},si;function jr(){}P(jr,ti),jr.prototype.g=function(){return new XMLHttpRequest},jr.prototype.i=function(){return{}},si=new jr;function pt(i,c,h,f){this.j=i,this.i=c,this.l=h,this.R=f||1,this.U=new Mn(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new ua}function ua(){this.i=null,this.g="",this.h=!1}var ha={},ii={};function oi(i,c,h){i.L=1,i.v=zr(nt(c)),i.m=h,i.P=!0,da(i,null)}function da(i,c){i.F=Date.now(),Br(i),i.A=nt(i.v);var h=i.A,f=i.R;Array.isArray(f)||(f=[String(f)]),ba(h.i,"t",f),i.C=0,h=i.j.J,i.h=new ua,i.g=za(i.j,h?c:null,!i.m),0<i.O&&(i.M=new $h(w(i.Y,i,i.g),i.O)),c=i.U,h=i.g,f=i.ca;var A="readystatechange";Array.isArray(A)||(A&&(ta[0]=A.toString()),A=ta);for(var b=0;b<A.length;b++){var O=Lr(h,A[b],f||c.handleEvent,!1,c.h||c);if(!O)break;c.g[O.key]=O}c=i.H?m(i.H):{},i.m?(i.u||(i.u="POST"),c["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.A,i.u,i.m,c)):(i.u="GET",i.g.ea(i.A,i.u,null,c)),Un(),Wh(i.i,i.u,i.A,i.l,i.R,i.m)}pt.prototype.ca=function(i){i=i.target;const c=this.M;c&&rt(i)==3?c.j():this.Y(i)},pt.prototype.Y=function(i){try{if(i==this.g)e:{const Se=rt(this.g);var c=this.g.Ba();const an=this.g.Z();if(!(3>Se)&&(Se!=3||this.g&&(this.h.h||this.g.oa()||Va(this.g)))){this.J||Se!=4||c==7||(c==8||0>=an?Un(3):Un(2)),ai(this);var h=this.g.Z();this.X=h;t:if(fa(this)){var f=Va(this.g);i="";var A=f.length,b=rt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Lt(this),$n(this);var O="";break t}this.h.i=new l.TextDecoder}for(c=0;c<A;c++)this.h.h=!0,i+=this.h.i.decode(f[c],{stream:!(b&&c==A-1)});f.length=0,this.h.g+=i,this.C=0,O=this.h.g}else O=this.g.oa();if(this.o=h==200,Gh(this.i,this.u,this.A,this.l,this.R,Se,h),this.o){if(this.T&&!this.K){t:{if(this.g){var ee,Ee=this.g;if((ee=Ee.g?Ee.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!x(ee)){var Q=ee;break t}}Q=null}if(h=Q)rn(this.i,this.l,h,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,ci(this,h);else{this.o=!1,this.s=3,Ve(12),Lt(this),$n(this);break e}}if(this.P){h=!0;let qe;for(;!this.J&&this.C<O.length;)if(qe=Qh(this,O),qe==ii){Se==4&&(this.s=4,Ve(14),h=!1),rn(this.i,this.l,null,"[Incomplete Response]");break}else if(qe==ha){this.s=4,Ve(15),rn(this.i,this.l,O,"[Invalid Chunk]"),h=!1;break}else rn(this.i,this.l,qe,null),ci(this,qe);if(fa(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Se!=4||O.length!=0||this.h.h||(this.s=1,Ve(16),h=!1),this.o=this.o&&h,!h)rn(this.i,this.l,O,"[Invalid Chunked Response]"),Lt(this),$n(this);else if(0<O.length&&!this.W){this.W=!0;var be=this.j;be.g==this&&be.ba&&!be.M&&(be.j.info("Great, no buffering proxy detected. Bytes received: "+O.length),pi(be),be.M=!0,Ve(11))}}else rn(this.i,this.l,O,null),ci(this,O);Se==4&&Lt(this),this.o&&!this.J&&(Se==4?ja(this.j,this):(this.o=!1,Br(this)))}else dd(this.g),h==400&&0<O.indexOf("Unknown SID")?(this.s=3,Ve(12)):(this.s=0,Ve(13)),Lt(this),$n(this)}}}catch{}finally{}};function fa(i){return i.g?i.u=="GET"&&i.L!=2&&i.j.Ca:!1}function Qh(i,c){var h=i.C,f=c.indexOf(`
`,h);return f==-1?ii:(h=Number(c.substring(h,f)),isNaN(h)?ha:(f+=1,f+h>c.length?ii:(c=c.slice(f,f+h),i.C=f+h,c)))}pt.prototype.cancel=function(){this.J=!0,Lt(this)};function Br(i){i.S=Date.now()+i.I,pa(i,i.I)}function pa(i,c){if(i.B!=null)throw Error("WatchDog timer not null");i.B=jn(w(i.ba,i),c)}function ai(i){i.B&&(l.clearTimeout(i.B),i.B=null)}pt.prototype.ba=function(){this.B=null;const i=Date.now();0<=i-this.S?(Hh(this.i,this.A),this.L!=2&&(Un(),Ve(17)),Lt(this),this.s=2,$n(this)):pa(this,this.S-i)};function $n(i){i.j.G==0||i.J||ja(i.j,i)}function Lt(i){ai(i);var c=i.M;c&&typeof c.ma=="function"&&c.ma(),i.M=null,na(i.U),i.g&&(c=i.g,i.g=null,c.abort(),c.ma())}function ci(i,c){try{var h=i.j;if(h.G!=0&&(h.g==i||li(h.h,i))){if(!i.K&&li(h.h,i)&&h.G==3){try{var f=h.Da.g.parse(c)}catch{f=null}if(Array.isArray(f)&&f.length==3){var A=f;if(A[0]==0){e:if(!h.u){if(h.g)if(h.g.F+3e3<i.F)Xr(h),Kr(h);else break e;fi(h),Ve(18)}}else h.za=A[1],0<h.za-h.T&&37500>A[2]&&h.F&&h.v==0&&!h.C&&(h.C=jn(w(h.Za,h),6e3));if(1>=ga(h.h)&&h.ca){try{h.ca()}catch{}h.ca=void 0}}else Ft(h,11)}else if((i.K||h.g==i)&&Xr(h),!x(c))for(A=h.Da.g.parse(c),c=0;c<A.length;c++){let Q=A[c];if(h.T=Q[0],Q=Q[1],h.G==2)if(Q[0]=="c"){h.K=Q[1],h.ia=Q[2];const be=Q[3];be!=null&&(h.la=be,h.j.info("VER="+h.la));const Se=Q[4];Se!=null&&(h.Aa=Se,h.j.info("SVER="+h.Aa));const an=Q[5];an!=null&&typeof an=="number"&&0<an&&(f=1.5*an,h.L=f,h.j.info("backChannelRequestTimeoutMs_="+f)),f=h;const qe=i.g;if(qe){const Jr=qe.g?qe.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Jr){var b=f.h;b.g||Jr.indexOf("spdy")==-1&&Jr.indexOf("quic")==-1&&Jr.indexOf("h2")==-1||(b.j=b.l,b.g=new Set,b.h&&(ui(b,b.h),b.h=null))}if(f.D){const mi=qe.g?qe.g.getResponseHeader("X-HTTP-Session-Id"):null;mi&&(f.ya=mi,ne(f.I,f.D,mi))}}h.G=3,h.l&&h.l.ua(),h.ba&&(h.R=Date.now()-i.F,h.j.info("Handshake RTT: "+h.R+"ms")),f=h;var O=i;if(f.qa=qa(f,f.J?f.ia:null,f.W),O.K){ya(f.h,O);var ee=O,Ee=f.L;Ee&&(ee.I=Ee),ee.B&&(ai(ee),Br(ee)),f.g=O}else Fa(f);0<h.i.length&&Qr(h)}else Q[0]!="stop"&&Q[0]!="close"||Ft(h,7);else h.G==3&&(Q[0]=="stop"||Q[0]=="close"?Q[0]=="stop"?Ft(h,7):di(h):Q[0]!="noop"&&h.l&&h.l.ta(Q),h.v=0)}}Un(4)}catch{}}var Xh=class{constructor(i,c){this.g=i,this.map=c}};function ma(i){this.l=i||10,l.PerformanceNavigationTiming?(i=l.performance.getEntriesByType("navigation"),i=0<i.length&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function _a(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function ga(i){return i.h?1:i.g?i.g.size:0}function li(i,c){return i.h?i.h==c:i.g?i.g.has(c):!1}function ui(i,c){i.g?i.g.add(c):i.h=c}function ya(i,c){i.h&&i.h==c?i.h=null:i.g&&i.g.has(c)&&i.g.delete(c)}ma.prototype.cancel=function(){if(this.i=va(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function va(i){if(i.h!=null)return i.i.concat(i.h.D);if(i.g!=null&&i.g.size!==0){let c=i.i;for(const h of i.g.values())c=c.concat(h.D);return c}return N(i.i)}function Yh(i){if(i.V&&typeof i.V=="function")return i.V();if(typeof Map<"u"&&i instanceof Map||typeof Set<"u"&&i instanceof Set)return Array.from(i.values());if(typeof i=="string")return i.split("");if(u(i)){for(var c=[],h=i.length,f=0;f<h;f++)c.push(i[f]);return c}c=[],h=0;for(f in i)c[h++]=i[f];return c}function Jh(i){if(i.na&&typeof i.na=="function")return i.na();if(!i.V||typeof i.V!="function"){if(typeof Map<"u"&&i instanceof Map)return Array.from(i.keys());if(!(typeof Set<"u"&&i instanceof Set)){if(u(i)||typeof i=="string"){var c=[];i=i.length;for(var h=0;h<i;h++)c.push(h);return c}c=[],h=0;for(const f in i)c[h++]=f;return c}}}function Ea(i,c){if(i.forEach&&typeof i.forEach=="function")i.forEach(c,void 0);else if(u(i)||typeof i=="string")Array.prototype.forEach.call(i,c,void 0);else for(var h=Jh(i),f=Yh(i),A=f.length,b=0;b<A;b++)c.call(void 0,f[b],h&&h[b],i)}var Ia=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Zh(i,c){if(i){i=i.split("&");for(var h=0;h<i.length;h++){var f=i[h].indexOf("="),A=null;if(0<=f){var b=i[h].substring(0,f);A=i[h].substring(f+1)}else b=i[h];c(b,A?decodeURIComponent(A.replace(/\+/g," ")):"")}}}function Mt(i){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,i instanceof Mt){this.h=i.h,$r(this,i.j),this.o=i.o,this.g=i.g,qr(this,i.s),this.l=i.l;var c=i.i,h=new Wn;h.i=c.i,c.g&&(h.g=new Map(c.g),h.h=c.h),Ta(this,h),this.m=i.m}else i&&(c=String(i).match(Ia))?(this.h=!1,$r(this,c[1]||"",!0),this.o=qn(c[2]||""),this.g=qn(c[3]||"",!0),qr(this,c[4]),this.l=qn(c[5]||"",!0),Ta(this,c[6]||"",!0),this.m=qn(c[7]||"")):(this.h=!1,this.i=new Wn(null,this.h))}Mt.prototype.toString=function(){var i=[],c=this.j;c&&i.push(zn(c,wa,!0),":");var h=this.g;return(h||c=="file")&&(i.push("//"),(c=this.o)&&i.push(zn(c,wa,!0),"@"),i.push(encodeURIComponent(String(h)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),h=this.s,h!=null&&i.push(":",String(h))),(h=this.l)&&(this.g&&h.charAt(0)!="/"&&i.push("/"),i.push(zn(h,h.charAt(0)=="/"?nd:td,!0))),(h=this.i.toString())&&i.push("?",h),(h=this.m)&&i.push("#",zn(h,sd)),i.join("")};function nt(i){return new Mt(i)}function $r(i,c,h){i.j=h?qn(c,!0):c,i.j&&(i.j=i.j.replace(/:$/,""))}function qr(i,c){if(c){if(c=Number(c),isNaN(c)||0>c)throw Error("Bad port number "+c);i.s=c}else i.s=null}function Ta(i,c,h){c instanceof Wn?(i.i=c,id(i.i,i.h)):(h||(c=zn(c,rd)),i.i=new Wn(c,i.h))}function ne(i,c,h){i.i.set(c,h)}function zr(i){return ne(i,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),i}function qn(i,c){return i?c?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function zn(i,c,h){return typeof i=="string"?(i=encodeURI(i).replace(c,ed),h&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function ed(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var wa=/[#\/\?@]/g,td=/[#\?:]/g,nd=/[#\?]/g,rd=/[#\?@]/g,sd=/#/g;function Wn(i,c){this.h=this.g=null,this.i=i||null,this.j=!!c}function mt(i){i.g||(i.g=new Map,i.h=0,i.i&&Zh(i.i,function(c,h){i.add(decodeURIComponent(c.replace(/\+/g," ")),h)}))}n=Wn.prototype,n.add=function(i,c){mt(this),this.i=null,i=sn(this,i);var h=this.g.get(i);return h||this.g.set(i,h=[]),h.push(c),this.h+=1,this};function Aa(i,c){mt(i),c=sn(i,c),i.g.has(c)&&(i.i=null,i.h-=i.g.get(c).length,i.g.delete(c))}function Ra(i,c){return mt(i),c=sn(i,c),i.g.has(c)}n.forEach=function(i,c){mt(this),this.g.forEach(function(h,f){h.forEach(function(A){i.call(c,A,f,this)},this)},this)},n.na=function(){mt(this);const i=Array.from(this.g.values()),c=Array.from(this.g.keys()),h=[];for(let f=0;f<c.length;f++){const A=i[f];for(let b=0;b<A.length;b++)h.push(c[f])}return h},n.V=function(i){mt(this);let c=[];if(typeof i=="string")Ra(this,i)&&(c=c.concat(this.g.get(sn(this,i))));else{i=Array.from(this.g.values());for(let h=0;h<i.length;h++)c=c.concat(i[h])}return c},n.set=function(i,c){return mt(this),this.i=null,i=sn(this,i),Ra(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[c]),this.h+=1,this},n.get=function(i,c){return i?(i=this.V(i),0<i.length?String(i[0]):c):c};function ba(i,c,h){Aa(i,c),0<h.length&&(i.i=null,i.g.set(sn(i,c),N(h)),i.h+=h.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],c=Array.from(this.g.keys());for(var h=0;h<c.length;h++){var f=c[h];const b=encodeURIComponent(String(f)),O=this.V(f);for(f=0;f<O.length;f++){var A=b;O[f]!==""&&(A+="="+encodeURIComponent(String(O[f]))),i.push(A)}}return this.i=i.join("&")};function sn(i,c){return c=String(c),i.j&&(c=c.toLowerCase()),c}function id(i,c){c&&!i.j&&(mt(i),i.i=null,i.g.forEach(function(h,f){var A=f.toLowerCase();f!=A&&(Aa(this,f),ba(this,A,h))},i)),i.j=c}function od(i,c){const h=new Bn;if(l.Image){const f=new Image;f.onload=S(_t,h,"TestLoadImage: loaded",!0,c,f),f.onerror=S(_t,h,"TestLoadImage: error",!1,c,f),f.onabort=S(_t,h,"TestLoadImage: abort",!1,c,f),f.ontimeout=S(_t,h,"TestLoadImage: timeout",!1,c,f),l.setTimeout(function(){f.ontimeout&&f.ontimeout()},1e4),f.src=i}else c(!1)}function ad(i,c){const h=new Bn,f=new AbortController,A=setTimeout(()=>{f.abort(),_t(h,"TestPingServer: timeout",!1,c)},1e4);fetch(i,{signal:f.signal}).then(b=>{clearTimeout(A),b.ok?_t(h,"TestPingServer: ok",!0,c):_t(h,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(A),_t(h,"TestPingServer: error",!1,c)})}function _t(i,c,h,f,A){try{A&&(A.onload=null,A.onerror=null,A.onabort=null,A.ontimeout=null),f(h)}catch{}}function cd(){this.g=new zh}function ld(i,c,h){const f=h||"";try{Ea(i,function(A,b){let O=A;d(A)&&(O=ei(A)),c.push(f+b+"="+encodeURIComponent(O))})}catch(A){throw c.push(f+"type="+encodeURIComponent("_badmap")),A}}function Wr(i){this.l=i.Ub||null,this.j=i.eb||!1}P(Wr,ti),Wr.prototype.g=function(){return new Gr(this.l,this.j)},Wr.prototype.i=function(i){return function(){return i}}({});function Gr(i,c){Re.call(this),this.D=i,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}P(Gr,Re),n=Gr.prototype,n.open=function(i,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=i,this.A=c,this.readyState=1,Hn(this)},n.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const c={headers:this.u,method:this.B,credentials:this.m,cache:void 0};i&&(c.body=i),(this.D||l).fetch(new Request(this.A,c)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Gn(this)),this.readyState=0},n.Sa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,Hn(this)),this.g&&(this.readyState=3,Hn(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Sa(this)}else i.text().then(this.Ra.bind(this),this.ga.bind(this))};function Sa(i){i.j.read().then(i.Pa.bind(i)).catch(i.ga.bind(i))}n.Pa=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var c=i.value?i.value:new Uint8Array(0);(c=this.v.decode(c,{stream:!i.done}))&&(this.response=this.responseText+=c)}i.done?Gn(this):Hn(this),this.readyState==3&&Sa(this)}},n.Ra=function(i){this.g&&(this.response=this.responseText=i,Gn(this))},n.Qa=function(i){this.g&&(this.response=i,Gn(this))},n.ga=function(){this.g&&Gn(this)};function Gn(i){i.readyState=4,i.l=null,i.j=null,i.v=null,Hn(i)}n.setRequestHeader=function(i,c){this.u.append(i,c)},n.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],c=this.h.entries();for(var h=c.next();!h.done;)h=h.value,i.push(h[0]+": "+h[1]),h=c.next();return i.join(`\r
`)};function Hn(i){i.onreadystatechange&&i.onreadystatechange.call(i)}Object.defineProperty(Gr.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(i){this.m=i?"include":"same-origin"}});function Pa(i){let c="";return te(i,function(h,f){c+=f,c+=":",c+=h,c+=`\r
`}),c}function hi(i,c,h){e:{for(f in h){var f=!1;break e}f=!0}f||(h=Pa(h),typeof i=="string"?h!=null&&encodeURIComponent(String(h)):ne(i,c,h))}function le(i){Re.call(this),this.headers=new Map,this.o=i||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}P(le,Re);var ud=/^https?$/i,hd=["POST","PUT"];n=le.prototype,n.Ha=function(i){this.J=i},n.ea=function(i,c,h,f){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);c=c?c.toUpperCase():"GET",this.D=i,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():si.g(),this.v=this.o?ra(this.o):ra(si),this.g.onreadystatechange=w(this.Ea,this);try{this.B=!0,this.g.open(c,String(i),!0),this.B=!1}catch(b){Ca(this,b);return}if(i=h||"",h=new Map(this.headers),f)if(Object.getPrototypeOf(f)===Object.prototype)for(var A in f)h.set(A,f[A]);else if(typeof f.keys=="function"&&typeof f.get=="function")for(const b of f.keys())h.set(b,f.get(b));else throw Error("Unknown input type for opt_headers: "+String(f));f=Array.from(h.keys()).find(b=>b.toLowerCase()=="content-type"),A=l.FormData&&i instanceof l.FormData,!(0<=Array.prototype.indexOf.call(hd,c,void 0))||f||A||h.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[b,O]of h)this.g.setRequestHeader(b,O);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Da(this),this.u=!0,this.g.send(i),this.u=!1}catch(b){Ca(this,b)}};function Ca(i,c){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=c,i.m=5,ka(i),Hr(i)}function ka(i){i.A||(i.A=!0,De(i,"complete"),De(i,"error"))}n.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=i||7,De(this,"complete"),De(this,"abort"),Hr(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Hr(this,!0)),le.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Na(this):this.bb())},n.bb=function(){Na(this)};function Na(i){if(i.h&&typeof a<"u"&&(!i.v[1]||rt(i)!=4||i.Z()!=2)){if(i.u&&rt(i)==4)Zo(i.Ea,0,i);else if(De(i,"readystatechange"),rt(i)==4){i.h=!1;try{const O=i.Z();e:switch(O){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break e;default:c=!1}var h;if(!(h=c)){var f;if(f=O===0){var A=String(i.D).match(Ia)[1]||null;!A&&l.self&&l.self.location&&(A=l.self.location.protocol.slice(0,-1)),f=!ud.test(A?A.toLowerCase():"")}h=f}if(h)De(i,"complete"),De(i,"success");else{i.m=6;try{var b=2<rt(i)?i.g.statusText:""}catch{b=""}i.l=b+" ["+i.Z()+"]",ka(i)}}finally{Hr(i)}}}}function Hr(i,c){if(i.g){Da(i);const h=i.g,f=i.v[0]?()=>{}:null;i.g=null,i.v=null,c||De(i,"ready");try{h.onreadystatechange=f}catch{}}}function Da(i){i.I&&(l.clearTimeout(i.I),i.I=null)}n.isActive=function(){return!!this.g};function rt(i){return i.g?i.g.readyState:0}n.Z=function(){try{return 2<rt(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(i){if(this.g){var c=this.g.responseText;return i&&c.indexOf(i)==0&&(c=c.substring(i.length)),qh(c)}};function Va(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.H){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function dd(i){const c={};i=(i.g&&2<=rt(i)&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let f=0;f<i.length;f++){if(x(i[f]))continue;var h=I(i[f]);const A=h[0];if(h=h[1],typeof h!="string")continue;h=h.trim();const b=c[A]||[];c[A]=b,b.push(h)}T(c,function(f){return f.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Kn(i,c,h){return h&&h.internalChannelParams&&h.internalChannelParams[i]||c}function Oa(i){this.Aa=0,this.i=[],this.j=new Bn,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Kn("failFast",!1,i),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Kn("baseRetryDelayMs",5e3,i),this.cb=Kn("retryDelaySeedMs",1e4,i),this.Wa=Kn("forwardChannelMaxRetries",2,i),this.wa=Kn("forwardChannelRequestTimeoutMs",2e4,i),this.pa=i&&i.xmlHttpFactory||void 0,this.Xa=i&&i.Tb||void 0,this.Ca=i&&i.useFetchStreams||!1,this.L=void 0,this.J=i&&i.supportsCrossDomainXhr||!1,this.K="",this.h=new ma(i&&i.concurrentRequestLimit),this.Da=new cd,this.P=i&&i.fastHandshake||!1,this.O=i&&i.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=i&&i.Rb||!1,i&&i.xa&&this.j.xa(),i&&i.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&i&&i.detectBufferingProxy||!1,this.ja=void 0,i&&i.longPollingTimeout&&0<i.longPollingTimeout&&(this.ja=i.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Oa.prototype,n.la=8,n.G=1,n.connect=function(i,c,h,f){Ve(0),this.W=i,this.H=c||{},h&&f!==void 0&&(this.H.OSID=h,this.H.OAID=f),this.F=this.X,this.I=qa(this,null,this.W),Qr(this)};function di(i){if(xa(i),i.G==3){var c=i.U++,h=nt(i.I);if(ne(h,"SID",i.K),ne(h,"RID",c),ne(h,"TYPE","terminate"),Qn(i,h),c=new pt(i,i.j,c),c.L=2,c.v=zr(nt(h)),h=!1,l.navigator&&l.navigator.sendBeacon)try{h=l.navigator.sendBeacon(c.v.toString(),"")}catch{}!h&&l.Image&&(new Image().src=c.v,h=!0),h||(c.g=za(c.j,null),c.g.ea(c.v)),c.F=Date.now(),Br(c)}$a(i)}function Kr(i){i.g&&(pi(i),i.g.cancel(),i.g=null)}function xa(i){Kr(i),i.u&&(l.clearTimeout(i.u),i.u=null),Xr(i),i.h.cancel(),i.s&&(typeof i.s=="number"&&l.clearTimeout(i.s),i.s=null)}function Qr(i){if(!_a(i.h)&&!i.s){i.s=!0;var c=i.Ga;Ue||He(),xe||(Ue(),xe=!0),Nn.add(c,i),i.B=0}}function fd(i,c){return ga(i.h)>=i.h.j-(i.s?1:0)?!1:i.s?(i.i=c.D.concat(i.i),!0):i.G==1||i.G==2||i.B>=(i.Va?0:i.Wa)?!1:(i.s=jn(w(i.Ga,i,c),Ba(i,i.B)),i.B++,!0)}n.Ga=function(i){if(this.s)if(this.s=null,this.G==1){if(!i){this.U=Math.floor(1e5*Math.random()),i=this.U++;const A=new pt(this,this.j,i);let b=this.o;if(this.S&&(b?(b=m(b),E(b,this.S)):b=this.S),this.m!==null||this.O||(A.H=b,b=null),this.P)e:{for(var c=0,h=0;h<this.i.length;h++){t:{var f=this.i[h];if("__data__"in f.map&&(f=f.map.__data__,typeof f=="string")){f=f.length;break t}f=void 0}if(f===void 0)break;if(c+=f,4096<c){c=h;break e}if(c===4096||h===this.i.length-1){c=h+1;break e}}c=1e3}else c=1e3;c=Ma(this,A,c),h=nt(this.I),ne(h,"RID",i),ne(h,"CVER",22),this.D&&ne(h,"X-HTTP-Session-Id",this.D),Qn(this,h),b&&(this.O?c="headers="+encodeURIComponent(String(Pa(b)))+"&"+c:this.m&&hi(h,this.m,b)),ui(this.h,A),this.Ua&&ne(h,"TYPE","init"),this.P?(ne(h,"$req",c),ne(h,"SID","null"),A.T=!0,oi(A,h,null)):oi(A,h,c),this.G=2}}else this.G==3&&(i?La(this,i):this.i.length==0||_a(this.h)||La(this))};function La(i,c){var h;c?h=c.l:h=i.U++;const f=nt(i.I);ne(f,"SID",i.K),ne(f,"RID",h),ne(f,"AID",i.T),Qn(i,f),i.m&&i.o&&hi(f,i.m,i.o),h=new pt(i,i.j,h,i.B+1),i.m===null&&(h.H=i.o),c&&(i.i=c.D.concat(i.i)),c=Ma(i,h,1e3),h.I=Math.round(.5*i.wa)+Math.round(.5*i.wa*Math.random()),ui(i.h,h),oi(h,f,c)}function Qn(i,c){i.H&&te(i.H,function(h,f){ne(c,f,h)}),i.l&&Ea({},function(h,f){ne(c,f,h)})}function Ma(i,c,h){h=Math.min(i.i.length,h);var f=i.l?w(i.l.Na,i.l,i):null;e:{var A=i.i;let b=-1;for(;;){const O=["count="+h];b==-1?0<h?(b=A[0].g,O.push("ofs="+b)):b=0:O.push("ofs="+b);let ee=!0;for(let Ee=0;Ee<h;Ee++){let Q=A[Ee].g;const be=A[Ee].map;if(Q-=b,0>Q)b=Math.max(0,A[Ee].g-100),ee=!1;else try{ld(be,O,"req"+Q+"_")}catch{f&&f(be)}}if(ee){f=O.join("&");break e}}}return i=i.i.splice(0,h),c.D=i,f}function Fa(i){if(!i.g&&!i.u){i.Y=1;var c=i.Fa;Ue||He(),xe||(Ue(),xe=!0),Nn.add(c,i),i.v=0}}function fi(i){return i.g||i.u||3<=i.v?!1:(i.Y++,i.u=jn(w(i.Fa,i),Ba(i,i.v)),i.v++,!0)}n.Fa=function(){if(this.u=null,Ua(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var i=2*this.R;this.j.info("BP detection timer enabled: "+i),this.A=jn(w(this.ab,this),i)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Ve(10),Kr(this),Ua(this))};function pi(i){i.A!=null&&(l.clearTimeout(i.A),i.A=null)}function Ua(i){i.g=new pt(i,i.j,"rpc",i.Y),i.m===null&&(i.g.H=i.o),i.g.O=0;var c=nt(i.qa);ne(c,"RID","rpc"),ne(c,"SID",i.K),ne(c,"AID",i.T),ne(c,"CI",i.F?"0":"1"),!i.F&&i.ja&&ne(c,"TO",i.ja),ne(c,"TYPE","xmlhttp"),Qn(i,c),i.m&&i.o&&hi(c,i.m,i.o),i.L&&(i.g.I=i.L);var h=i.g;i=i.ia,h.L=1,h.v=zr(nt(c)),h.m=null,h.P=!0,da(h,i)}n.Za=function(){this.C!=null&&(this.C=null,Kr(this),fi(this),Ve(19))};function Xr(i){i.C!=null&&(l.clearTimeout(i.C),i.C=null)}function ja(i,c){var h=null;if(i.g==c){Xr(i),pi(i),i.g=null;var f=2}else if(li(i.h,c))h=c.D,ya(i.h,c),f=1;else return;if(i.G!=0){if(c.o)if(f==1){h=c.m?c.m.length:0,c=Date.now()-c.F;var A=i.B;f=Fr(),De(f,new ca(f,h)),Qr(i)}else Fa(i);else if(A=c.s,A==3||A==0&&0<c.X||!(f==1&&fd(i,c)||f==2&&fi(i)))switch(h&&0<h.length&&(c=i.h,c.i=c.i.concat(h)),A){case 1:Ft(i,5);break;case 4:Ft(i,10);break;case 3:Ft(i,6);break;default:Ft(i,2)}}}function Ba(i,c){let h=i.Ta+Math.floor(Math.random()*i.cb);return i.isActive()||(h*=2),h*c}function Ft(i,c){if(i.j.info("Error code "+c),c==2){var h=w(i.fb,i),f=i.Xa;const A=!f;f=new Mt(f||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||$r(f,"https"),zr(f),A?od(f.toString(),h):ad(f.toString(),h)}else Ve(2);i.G=0,i.l&&i.l.sa(c),$a(i),xa(i)}n.fb=function(i){i?(this.j.info("Successfully pinged google.com"),Ve(2)):(this.j.info("Failed to ping google.com"),Ve(1))};function $a(i){if(i.G=0,i.ka=[],i.l){const c=va(i.h);(c.length!=0||i.i.length!=0)&&(D(i.ka,c),D(i.ka,i.i),i.h.i.length=0,N(i.i),i.i.length=0),i.l.ra()}}function qa(i,c,h){var f=h instanceof Mt?nt(h):new Mt(h);if(f.g!="")c&&(f.g=c+"."+f.g),qr(f,f.s);else{var A=l.location;f=A.protocol,c=c?c+"."+A.hostname:A.hostname,A=+A.port;var b=new Mt(null);f&&$r(b,f),c&&(b.g=c),A&&qr(b,A),h&&(b.l=h),f=b}return h=i.D,c=i.ya,h&&c&&ne(f,h,c),ne(f,"VER",i.la),Qn(i,f),f}function za(i,c,h){if(c&&!i.J)throw Error("Can't create secondary domain capable XhrIo object.");return c=i.Ca&&!i.pa?new le(new Wr({eb:h})):new le(i.pa),c.Ha(i.J),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Wa(){}n=Wa.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function Yr(){}Yr.prototype.g=function(i,c){return new je(i,c)};function je(i,c){Re.call(this),this.g=new Oa(c),this.l=i,this.h=c&&c.messageUrlParams||null,i=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(i?i["X-WebChannel-Content-Type"]=c.messageContentType:i={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.va&&(i?i["X-WebChannel-Client-Profile"]=c.va:i={"X-WebChannel-Client-Profile":c.va}),this.g.S=i,(i=c&&c.Sb)&&!x(i)&&(this.g.m=i),this.v=c&&c.supportsCrossDomainXhr||!1,this.u=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!x(c)&&(this.g.D=c,i=this.h,i!==null&&c in i&&(i=this.h,c in i&&delete i[c])),this.j=new on(this)}P(je,Re),je.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},je.prototype.close=function(){di(this.g)},je.prototype.o=function(i){var c=this.g;if(typeof i=="string"){var h={};h.__data__=i,i=h}else this.u&&(h={},h.__data__=ei(i),i=h);c.i.push(new Xh(c.Ya++,i)),c.G==3&&Qr(c)},je.prototype.N=function(){this.g.l=null,delete this.j,di(this.g),delete this.g,je.aa.N.call(this)};function Ga(i){ni.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var c=i.__sm__;if(c){e:{for(const h in c){i=h;break e}i=void 0}(this.i=i)&&(i=this.i,c=c!==null&&i in c?c[i]:void 0),this.data=c}else this.data=i}P(Ga,ni);function Ha(){ri.call(this),this.status=1}P(Ha,ri);function on(i){this.g=i}P(on,Wa),on.prototype.ua=function(){De(this.g,"a")},on.prototype.ta=function(i){De(this.g,new Ga(i))},on.prototype.sa=function(i){De(this.g,new Ha)},on.prototype.ra=function(){De(this.g,"b")},Yr.prototype.createWebChannel=Yr.prototype.g,je.prototype.send=je.prototype.o,je.prototype.open=je.prototype.m,je.prototype.close=je.prototype.close,_u=function(){return new Yr},mu=function(){return Fr()},pu=xt,Fi={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Ur.NO_ERROR=0,Ur.TIMEOUT=8,Ur.HTTP_ERROR=6,cs=Ur,la.COMPLETE="complete",fu=la,sa.EventType=Fn,Fn.OPEN="a",Fn.CLOSE="b",Fn.ERROR="c",Fn.MESSAGE="d",Re.prototype.listen=Re.prototype.K,rr=sa,le.prototype.listenOnce=le.prototype.L,le.prototype.getLastError=le.prototype.Ka,le.prototype.getLastErrorCode=le.prototype.Ba,le.prototype.getStatus=le.prototype.Z,le.prototype.getResponseJson=le.prototype.Oa,le.prototype.getResponseText=le.prototype.oa,le.prototype.send=le.prototype.ea,le.prototype.setWithCredentials=le.prototype.Ha,du=le}).apply(typeof es<"u"?es:typeof self<"u"?self:typeof window<"u"?window:{});const bc="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qt=new eo("@firebase/firestore");function Xn(){return Qt.logLevel}function M(n,...e){if(Qt.logLevel<=H.DEBUG){const t=e.map(fo);Qt.debug(`Firestore (${Sn}): ${n}`,...t)}}function ut(n,...e){if(Qt.logLevel<=H.ERROR){const t=e.map(fo);Qt.error(`Firestore (${Sn}): ${n}`,...t)}}function mr(n,...e){if(Qt.logLevel<=H.WARN){const t=e.map(fo);Qt.warn(`Firestore (${Sn}): ${n}`,...t)}}function fo(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $(n="Unexpected state"){const e=`FIRESTORE (${Sn}) INTERNAL ASSERTION FAILED: `+n;throw ut(e),new Error(e)}function J(n,e){n||$()}function z(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _r{constructor(e,t,r){t===void 0?t=0:t>e.length&&$(),r===void 0?r=e.length-t:r>e.length-t&&$(),this.segments=e,this.offset=t,this.len=r}get length(){return this.len}isEqual(e){return _r.comparator(this,e)===0}child(e){const t=this.segments.slice(this.offset,this.limit());return e instanceof _r?e.forEach(r=>{t.push(r)}):t.push(e),this.construct(t)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}forEach(e){for(let t=this.offset,r=this.limit();t<r;t++)e(this.segments[t])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,t){const r=Math.min(e.length,t.length);for(let s=0;s<r;s++){const o=e.get(s),a=t.get(s);if(o<a)return-1;if(o>a)return 1}return e.length<t.length?-1:e.length>t.length?1:0}}class se extends _r{construct(e,t,r){return new se(e,t,r)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const t=[];for(const r of e){if(r.indexOf("//")>=0)throw new L(C.INVALID_ARGUMENT,`Invalid segment (${r}). Paths must not contain // in them.`);t.push(...r.split("/").filter(s=>s.length>0))}return new se(t)}static emptyPath(){return new se([])}}const D_=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class Te extends _r{construct(e,t,r){return new Te(e,t,r)}static isValidIdentifier(e){return D_.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),Te.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)==="__name__"}static keyField(){return new Te(["__name__"])}static fromServerFormat(e){const t=[];let r="",s=0;const o=()=>{if(r.length===0)throw new L(C.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);t.push(r),r=""};let a=!1;for(;s<e.length;){const l=e[s];if(l==="\\"){if(s+1===e.length)throw new L(C.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const u=e[s+1];if(u!=="\\"&&u!=="."&&u!=="`")throw new L(C.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);r+=u,s+=2}else l==="`"?(a=!a,s++):l!=="."||a?(r+=l,s++):(o(),s++)}if(o(),a)throw new L(C.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new Te(t)}static emptyPath(){return new Te([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cr(n){if(n.code!==C.FAILED_PRECONDITION||n.message!==L_)throw n;M("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{constructor(e){this.fields=e,e.sort(Te.comparator)}static empty(){return new Be([])}unionWith(e){let t=new we(Te.comparator);for(const r of this.fields)t=t.add(r);for(const r of e)t=t.add(r);return new Be(t.toArray())}covers(e){for(const t of this.fields)if(t.isPrefixOf(e))return!0;return!1}isEqual(e){return yn(this.fields,e.fields,(t,r)=>t.isEqual(r))}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ae{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(s){try{return atob(s)}catch(o){throw typeof DOMException<"u"&&o instanceof DOMException?new vu("Invalid base64 string: "+o):o}}(e);return new Ae(t)}static fromUint8Array(e){const t=function(s){let o="";for(let a=0;a<s.length;++a)o+=String.fromCharCode(s[a]);return o}(e);return new Ae(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Y(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Ae.EMPTY_BYTE_STRING=new Ae("");const j_=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Pt(n){if(J(!!n),typeof n=="string"){let e=0;const t=j_.exec(n);if(J(!!t),t[1]){let s=t[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:fe(n.seconds),nanos:fe(n.nanos)}}function fe(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function Xt(n){return typeof n=="string"?Ae.fromBase64String(n):Ae.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mo(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function _o(n){const e=n.mapValue.fields.__previous_value__;return mo(e)?_o(e):e}function gr(n){const e=Pt(n.mapValue.fields.__local_write_time__.timestampValue);return new pe(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Me{constructor(e){this.value=e}static empty(){return new Me({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!ls(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=cr(t)}setAll(e){let t=Te.emptyPath(),r={},s=[];e.forEach((a,l)=>{if(!t.isImmediateParentOf(l)){const u=this.getFieldsMap(t);this.applyChanges(u,r,s),r={},s=[],t=l.popLast()}a?r[l.lastSegment()]=cr(a):s.push(l.lastSegment())});const o=this.getFieldsMap(t);this.applyChanges(o,r,s)}delete(e){const t=this.field(e.popLast());ls(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return et(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];ls(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){Jt(t,(s,o)=>e[s]=o);for(const s of r)delete e[s]}clone(){return new Me(cr(this.value))}}function Eu(n){const e=[];return Jt(n.fields,(t,r)=>{const s=new Te([t]);if(ls(r)){const o=Eu(r.mapValue).fields;if(o.length===0)e.push(s);else for(const a of o)e.push(s.child(a))}else e.push(s)}),new Be(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ce{constructor(e,t,r,s,o,a,l){this.key=e,this.documentType=t,this.version=r,this.readTime=s,this.createTime=o,this.data=a,this.documentState=l}static newInvalidDocument(e){return new Ce(e,0,q.min(),q.min(),q.min(),Me.empty(),0)}static newFoundDocument(e,t,r,s){return new Ce(e,1,t,q.min(),r,s,0)}static newNoDocument(e,t){return new Ce(e,2,t,q.min(),q.min(),Me.empty(),0)}static newUnknownDocument(e,t){return new Ce(e,3,t,q.min(),q.min(),Me.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(q.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=Me.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=Me.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=q.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Ce&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Ce(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iu{}class _e extends Iu{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new G_(e,t,r):t==="array-contains"?new Q_(e,r):t==="in"?new X_(e,r):t==="not-in"?new Y_(e,r):t==="array-contains-any"?new J_(e,r):new _e(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new H_(e,r):new K_(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&this.matchesComparison(vn(t,this.value)):t!==null&&Yt(this.value)===Yt(t)&&this.matchesComparison(vn(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return $()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Ge extends Iu{constructor(e,t){super(),this.filters=e,this.op=t,this.ae=null}static create(e,t){return new Ge(e,t)}matches(e){return Tu(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Tu(n){return n.op==="and"}function wu(n){return W_(n)&&Tu(n)}function W_(n){for(const e of n.filters)if(e instanceof Ge)return!1;return!0}function Bi(n){if(n instanceof _e)return n.field.canonicalString()+n.op.toString()+En(n.value);if(wu(n))return n.filters.map(e=>Bi(e)).join(",");{const e=n.filters.map(t=>Bi(t)).join(",");return`${n.op}(${e})`}}function Au(n,e){return n instanceof _e?function(r,s){return s instanceof _e&&r.op===s.op&&r.field.isEqual(s.field)&&et(r.value,s.value)}(n,e):n instanceof Ge?function(r,s){return s instanceof Ge&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce((o,a,l)=>o&&Au(a,s.filters[l]),!0):!1}(n,e):void $()}function Ru(n){return n instanceof _e?function(t){return`${t.field.canonicalString()} ${t.op} ${En(t.value)}`}(n):n instanceof Ge?function(t){return t.op.toString()+" {"+t.getFilters().map(Ru).join(" ,")+"}"}(n):"Filter"}class G_ extends _e{constructor(e,t,r){super(e,t,r),this.key=F.fromName(r.referenceValue)}matches(e){const t=F.comparator(e.key,this.key);return this.matchesComparison(t)}}class H_ extends _e{constructor(e,t){super(e,"in",t),this.keys=bu("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class K_ extends _e{constructor(e,t){super(e,"not-in",t),this.keys=bu("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function bu(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(r=>F.fromName(r.referenceValue))}class Q_ extends _e{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return go(t)&&vr(t.arrayValue,this.value)}}class X_ extends _e{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&vr(this.value.arrayValue,t)}}class Y_ extends _e{constructor(e,t){super(e,"not-in",t)}matches(e){if(vr(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&!vr(this.value.arrayValue,t)}}class J_ extends _e{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!go(t)||!t.arrayValue.values)&&t.arrayValue.values.some(r=>vr(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sg=new ce(F.comparator);function ht(){return sg}const ku=new ce(F.comparator);function sr(...n){let e=ku;for(const t of n)e=e.insert(t.key,t);return e}function Nu(n){let e=ku;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Bt(){return ur()}function Du(){return ur()}function ur(){return new Cn(n=>n.toString(),(n,e)=>n.isEqual(e))}const ig=new ce(F.comparator),og=new we(F.comparator);function W(...n){let e=og;for(const t of n)e=e.add(t);return e}const ag=new we(Y);function cg(){return ag}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class js{constructor(e,t,r,s,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,Dr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new js(q.min(),s,new ce(Y),ht(),W())}}class Dr{constructor(e,t,r,s,o){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Dr(r,t,W(),W(),W())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hs{constructor(e,t,r,s){this.Re=e,this.removedTargetIds=t,this.key=r,this.Ve=s}}class Bu{constructor(e,t){this.targetId=e,this.me=t}}class $u{constructor(e,t,r=Ae.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class zc{constructor(){this.fe=0,this.ge=Gc(),this.pe=Ae.EMPTY_BYTE_STRING,this.ye=!1,this.we=!0}get current(){return this.ye}get resumeToken(){return this.pe}get Se(){return this.fe!==0}get be(){return this.we}De(e){e.approximateByteSize()>0&&(this.we=!0,this.pe=e)}ve(){let e=W(),t=W(),r=W();return this.ge.forEach((s,o)=>{switch(o){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:$()}}),new Dr(this.pe,this.ye,e,t,r)}Ce(){this.we=!1,this.ge=Gc()}Fe(e,t){this.we=!0,this.ge=this.ge.insert(e,t)}Me(e){this.we=!0,this.ge=this.ge.remove(e)}xe(){this.fe+=1}Oe(){this.fe-=1,J(this.fe>=0)}Ne(){this.we=!0,this.ye=!0}}class wg{constructor(e){this.Le=e,this.Be=new Map,this.ke=ht(),this.qe=Wc(),this.Qe=new ce(Y)}Ke(e){for(const t of e.Re)e.Ve&&e.Ve.isFoundDocument()?this.$e(t,e.Ve):this.Ue(t,e.key,e.Ve);for(const t of e.removedTargetIds)this.Ue(t,e.key,e.Ve)}We(e){this.forEachTarget(e,t=>{const r=this.Ge(t);switch(e.state){case 0:this.ze(t)&&r.De(e.resumeToken);break;case 1:r.Oe(),r.Se||r.Ce(),r.De(e.resumeToken);break;case 2:r.Oe(),r.Se||this.removeTarget(t);break;case 3:this.ze(t)&&(r.Ne(),r.De(e.resumeToken));break;case 4:this.ze(t)&&(this.je(t),r.De(e.resumeToken));break;default:$()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Be.forEach((r,s)=>{this.ze(s)&&t(s)})}He(e){const t=e.targetId,r=e.me.count,s=this.Je(t);if(s){const o=s.target;if($i(o))if(r===0){const a=new F(o.path);this.Ue(t,a,Ce.newNoDocument(a,q.min()))}else J(r===1);else{const a=this.Ye(t);if(a!==r){const l=this.Ze(e),u=l?this.Xe(l,e,a):1;if(u!==0){this.je(t);const d=u===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Qe=this.Qe.insert(t,d)}}}}}Ze(e){const t=e.me.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:o=0}=t;let a,l;try{a=Xt(r).toUint8Array()}catch(u){if(u instanceof vu)return mr("Decoding the base64 bloom filter in existence filter failed ("+u.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw u}try{l=new Ao(a,s,o)}catch(u){return mr(u instanceof ir?"BloomFilter error: ":"Applying bloom filter failed: ",u),null}return l.Ie===0?null:l}Xe(e,t,r){return t.me.count===r-this.nt(e,t.targetId)?0:2}nt(e,t){const r=this.Le.getRemoteKeysForTarget(t);let s=0;return r.forEach(o=>{const a=this.Le.tt(),l=`projects/${a.projectId}/databases/${a.database}/documents/${o.path.canonicalString()}`;e.mightContain(l)||(this.Ue(t,o,null),s++)}),s}rt(e){const t=new Map;this.Be.forEach((o,a)=>{const l=this.Je(a);if(l){if(o.current&&$i(l.target)){const u=new F(l.target.path);this.ke.get(u)!==null||this.it(a,u)||this.Ue(a,u,Ce.newNoDocument(u,e))}o.be&&(t.set(a,o.ve()),o.Ce())}});let r=W();this.qe.forEach((o,a)=>{let l=!0;a.forEachWhile(u=>{const d=this.Je(u);return!d||d.purpose==="TargetPurposeLimboResolution"||(l=!1,!1)}),l&&(r=r.add(o))}),this.ke.forEach((o,a)=>a.setReadTime(e));const s=new js(e,t,this.Qe,this.ke,r);return this.ke=ht(),this.qe=Wc(),this.Qe=new ce(Y),s}$e(e,t){if(!this.ze(e))return;const r=this.it(e,t.key)?2:0;this.Ge(e).Fe(t.key,r),this.ke=this.ke.insert(t.key,t),this.qe=this.qe.insert(t.key,this.st(t.key).add(e))}Ue(e,t,r){if(!this.ze(e))return;const s=this.Ge(e);this.it(e,t)?s.Fe(t,1):s.Me(t),this.qe=this.qe.insert(t,this.st(t).delete(e)),r&&(this.ke=this.ke.insert(t,r))}removeTarget(e){this.Be.delete(e)}Ye(e){const t=this.Ge(e).ve();return this.Le.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}xe(e){this.Ge(e).xe()}Ge(e){let t=this.Be.get(e);return t||(t=new zc,this.Be.set(e,t)),t}st(e){let t=this.qe.get(e);return t||(t=new we(Y),this.qe=this.qe.insert(e,t)),t}ze(e){const t=this.Je(e)!==null;return t||M("WatchChangeAggregator","Detected inactive target",e),t}Je(e){const t=this.Be.get(e);return t&&t.Se?null:this.Le.ot(e)}je(e){this.Be.set(e,new zc),this.Le.getRemoteKeysForTarget(e).forEach(t=>{this.Ue(e,t,null)})}it(e,t){return this.Le.getRemoteKeysForTarget(e).has(t)}}function Wc(){return new ce(F.comparator)}function Gc(){return new ce(F.comparator)}const Ag={asc:"ASCENDING",desc:"DESCENDING"},Rg={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},bg={and:"AND",or:"OR"};class Sg{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Wi(n,e){return n.useProto3Json||xs(e)?e:{value:e}}function Rs(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function qu(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function Pg(n,e){return Rs(n,e.toTimestamp())}function Ze(n){return J(!!n),q.fromTimestamp(function(t){const r=Pt(t);return new pe(r.seconds,r.nanos)}(n))}function Ro(n,e){return Gi(n,e).canonicalString()}function Gi(n,e){const t=function(s){return new se(["projects",s.projectId,"databases",s.database])}(n).child("documents");return e===void 0?t:t.child(e)}function zu(n){const e=se.fromString(n);return J(Qu(e)),e}function Hi(n,e){return Ro(n.databaseId,e.path)}function wi(n,e){const t=zu(e);if(t.get(1)!==n.databaseId.projectId)throw new L(C.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new L(C.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new F(Gu(t))}function Wu(n,e){return Ro(n.databaseId,e)}function Cg(n){const e=zu(n);return e.length===4?se.emptyPath():Gu(e)}function Ki(n){return new se(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function Gu(n){return J(n.length>4&&n.get(4)==="documents"),n.popFirst(5)}function Hc(n,e,t){return{name:Hi(n,e),fields:t.value.mapValue.fields}}function kg(n,e){let t;if("targetChange"in e){e.targetChange;const r=function(d){return d==="NO_CHANGE"?0:d==="ADD"?1:d==="REMOVE"?2:d==="CURRENT"?3:d==="RESET"?4:$()}(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],o=function(d,p){return d.useProto3Json?(J(p===void 0||typeof p=="string"),Ae.fromBase64String(p||"")):(J(p===void 0||p instanceof Buffer||p instanceof Uint8Array),Ae.fromUint8Array(p||new Uint8Array))}(n,e.targetChange.resumeToken),a=e.targetChange.cause,l=a&&function(d){const p=d.code===void 0?C.UNKNOWN:ju(d.code);return new L(p,d.message||"")}(a);t=new $u(r,s,o,l||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=wi(n,r.document.name),o=Ze(r.document.updateTime),a=r.document.createTime?Ze(r.document.createTime):q.min(),l=new Me({mapValue:{fields:r.document.fields}}),u=Ce.newFoundDocument(s,o,a,l),d=r.targetIds||[],p=r.removedTargetIds||[];t=new hs(d,p,u.key,u)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=wi(n,r.document),o=r.readTime?Ze(r.readTime):q.min(),a=Ce.newNoDocument(s,o),l=r.removedTargetIds||[];t=new hs([],l,a.key,a)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=wi(n,r.document),o=r.removedTargetIds||[];t=new hs([],o,s,null)}else{if(!("filter"in e))return $();{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:o}=r,a=new vg(s,o),l=r.targetId;t=new Bu(l,a)}}return t}function Ng(n,e){let t;if(e instanceof Nr)t={update:Hc(n,e.key,e.value)};else if(e instanceof To)t={delete:Hi(n,e.key)};else if(e instanceof Nt)t={update:Hc(n,e.key,e.data),updateMask:jg(e.fieldMask)};else{if(!(e instanceof _g))return $();t={verify:Hi(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(r=>function(o,a){const l=a.transform;if(l instanceof ws)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(l instanceof Ir)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:l.elements}};if(l instanceof Tr)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:l.elements}};if(l instanceof As)return{fieldPath:a.field.canonicalString(),increment:l.Pe};throw $()}(0,r))),e.precondition.isNone||(t.currentDocument=function(s,o){return o.updateTime!==void 0?{updateTime:Pg(s,o.updateTime)}:o.exists!==void 0?{exists:o.exists}:$()}(n,e.precondition)),t}function Dg(n,e){return n&&n.length>0?(J(e!==void 0),n.map(t=>function(s,o){let a=s.updateTime?Ze(s.updateTime):Ze(o);return a.isEqual(q.min())&&(a=Ze(o)),new fg(a,s.transformResults||[])}(t,e))):[]}function Vg(n,e){return{documents:[Wu(n,e.path)]}}function Og(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=Wu(n,s);const o=function(d){if(d.length!==0)return Ku(Ge.create(d,"and"))}(e.filters);o&&(t.structuredQuery.where=o);const a=function(d){if(d.length!==0)return d.map(p=>function(w){return{field:ln(w.field),direction:Mg(w.dir)}}(p))}(e.orderBy);a&&(t.structuredQuery.orderBy=a);const l=Wi(n,e.limit);return l!==null&&(t.structuredQuery.limit=l),e.startAt&&(t.structuredQuery.startAt=function(d){return{before:d.inclusive,values:d.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(d){return{before:!d.inclusive,values:d.position}}(e.endAt)),{_t:t,parent:s}}function xg(n){let e=Cg(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){J(r===1);const p=t.from[0];p.allDescendants?s=p.collectionId:e=e.child(p.collectionId)}let o=[];t.where&&(o=function(g){const w=Hu(g);return w instanceof Ge&&wu(w)?w.getFilters():[w]}(t.where));let a=[];t.orderBy&&(a=function(g){return g.map(w=>function(P){return new Er(un(P.field),function(D){switch(D){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(P.direction))}(w))}(t.orderBy));let l=null;t.limit&&(l=function(g){let w;return w=typeof g=="object"?g.value:g,xs(w)?null:w}(t.limit));let u=null;t.startAt&&(u=function(g){const w=!!g.before,S=g.values||[];return new Ts(S,w)}(t.startAt));let d=null;return t.endAt&&(d=function(g){const w=!g.before,S=g.values||[];return new Ts(S,w)}(t.endAt)),eg(e,s,a,o,l,"F",u,d)}function Lg(n,e){const t=function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return $()}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function Hu(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=un(t.unaryFilter.field);return _e.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=un(t.unaryFilter.field);return _e.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const o=un(t.unaryFilter.field);return _e.create(o,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=un(t.unaryFilter.field);return _e.create(a,"!=",{nullValue:"NULL_VALUE"});default:return $()}}(n):n.fieldFilter!==void 0?function(t){return _e.create(un(t.fieldFilter.field),function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return $()}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return Ge.create(t.compositeFilter.filters.map(r=>Hu(r)),function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return $()}}(t.compositeFilter.op))}(n):$()}function Mg(n){return Ag[n]}function Fg(n){return Rg[n]}function Ug(n){return bg[n]}function ln(n){return{fieldPath:n.canonicalString()}}function un(n){return Te.fromServerFormat(n.fieldPath)}function Ku(n){return n instanceof _e?function(t){if(t.op==="=="){if(Vc(t.value))return{unaryFilter:{field:ln(t.field),op:"IS_NAN"}};if(Dc(t.value))return{unaryFilter:{field:ln(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(Vc(t.value))return{unaryFilter:{field:ln(t.field),op:"IS_NOT_NAN"}};if(Dc(t.value))return{unaryFilter:{field:ln(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:ln(t.field),op:Fg(t.op),value:t.value}}}(n):n instanceof Ge?function(t){const r=t.getFilters().map(s=>Ku(s));return r.length===1?r[0]:{compositeFilter:{op:Ug(t.op),filters:r}}}(n):$()}function jg(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function Qu(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wg{constructor(){this.changes=new Cn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Ce.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?k.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hg{constructor(e,t,r,s){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=s}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(s=>(r=s,this.remoteDocumentCache.getEntry(e,t))).next(s=>(r!==null&&hr(r.mutation,s,Be.empty(),pe.now()),s))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.getLocalViewOfDocuments(e,r,W()).next(()=>r))}getLocalViewOfDocuments(e,t,r=W()){const s=Bt();return this.populateOverlays(e,s,t).next(()=>this.computeViews(e,t,s,r).next(o=>{let a=sr();return o.forEach((l,u)=>{a=a.insert(l,u.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const r=Bt();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,W()))}populateOverlays(e,t,r){const s=[];return r.forEach(o=>{t.has(o)||s.push(o)}),this.documentOverlayCache.getOverlays(e,s).next(o=>{o.forEach((a,l)=>{t.set(a,l)})})}computeViews(e,t,r,s){let o=ht();const a=ur(),l=function(){return ur()}();return t.forEach((u,d)=>{const p=r.get(d.key);s.has(d.key)&&(p===void 0||p.mutation instanceof Nt)?o=o.insert(d.key,d):p!==void 0?(a.set(d.key,p.mutation.getFieldMask()),hr(p.mutation,d,p.mutation.getFieldMask(),pe.now())):a.set(d.key,Be.empty())}),this.recalculateAndSaveOverlays(e,o).next(u=>(u.forEach((d,p)=>a.set(d,p)),t.forEach((d,p)=>{var g;return l.set(d,new Gg(p,(g=a.get(d))!==null&&g!==void 0?g:null))}),l))}recalculateAndSaveOverlays(e,t){const r=ur();let s=new ce((a,l)=>a-l),o=W();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const l of a)l.keys().forEach(u=>{const d=t.get(u);if(d===null)return;let p=r.get(u)||Be.empty();p=l.applyToLocalView(d,p),r.set(u,p);const g=(s.get(l.batchId)||W()).add(u);s=s.insert(l.batchId,g)})}).next(()=>{const a=[],l=s.getReverseIterator();for(;l.hasNext();){const u=l.getNext(),d=u.key,p=u.value,g=Du();p.forEach(w=>{if(!o.has(w)){const S=Fu(t.get(w),r.get(w));S!==null&&g.set(w,S),o=o.add(w)}}),a.push(this.documentOverlayCache.saveOverlays(e,d,g))}return k.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,t,r,s){return function(a){return F.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Su(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,s):this.getDocumentsMatchingCollectionQuery(e,t,r,s)}getNextDocuments(e,t,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,s).next(o=>{const a=s-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,s-o.size):k.resolve(Bt());let l=-1,u=o;return a.next(d=>k.forEach(d,(p,g)=>(l<g.largestBatchId&&(l=g.largestBatchId),o.get(p)?k.resolve():this.remoteDocumentCache.getEntry(e,p).next(w=>{u=u.insert(p,w)}))).next(()=>this.populateOverlays(e,d,o)).next(()=>this.computeViews(e,u,d,W())).next(p=>({batchId:l,changes:Nu(p)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new F(t)).next(r=>{let s=sr();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(e,t,r,s){const o=t.collectionGroup;let a=sr();return this.indexManager.getCollectionParents(e,o).next(l=>k.forEach(l,u=>{const d=function(g,w){return new Pn(w,null,g.explicitOrderBy.slice(),g.filters.slice(),g.limit,g.limitType,g.startAt,g.endAt)}(t,u.child(o));return this.getDocumentsMatchingCollectionQuery(e,d,r,s).next(p=>{p.forEach((g,w)=>{a=a.insert(g,w)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,r,s){let o;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next(a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,o,s))).next(a=>{o.forEach((u,d)=>{const p=d.getKey();a.get(p)===null&&(a=a.insert(p,Ce.newInvalidDocument(p)))});let l=sr();return a.forEach((u,d)=>{const p=o.get(u);p!==void 0&&hr(p.mutation,d,Be.empty(),pe.now()),Ms(t,d)&&(l=l.insert(u,d))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xg{constructor(){this.sessionToken=Ae.EMPTY_BYTE_STRING}getSessionToken(e){return k.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,k.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bo{constructor(){this.Tr=new we(ve.Er),this.dr=new we(ve.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new ve(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new ve(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new F(new se([])),r=new ve(t,e),s=new ve(t,e+1),o=[];return this.dr.forEachInRange([r,s],a=>{this.Vr(a),o.push(a.key)}),o}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new F(new se([])),r=new ve(t,e),s=new ve(t,e+1);let o=W();return this.dr.forEachInRange([r,s],a=>{o=o.add(a.key)}),o}containsKey(e){const t=new ve(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class ve{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return F.comparator(e.key,t.key)||Y(e.wr,t.wr)}static Ar(e,t){return Y(e.wr,t.wr)||F.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yg{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Sr=1,this.br=new we(ve.Er)}checkEmpty(e){return k.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,r,s){const o=this.Sr;this.Sr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new gg(o,t,r,s);this.mutationQueue.push(a);for(const l of s)this.br=this.br.add(new ve(l.key,o)),this.indexManager.addToCollectionParentIndex(e,l.key.path.popLast());return k.resolve(a)}lookupMutationBatch(e,t){return k.resolve(this.Dr(t))}getNextMutationBatchAfterBatchId(e,t){const r=t+1,s=this.vr(r),o=s<0?0:s;return k.resolve(this.mutationQueue.length>o?this.mutationQueue[o]:null)}getHighestUnacknowledgedBatchId(){return k.resolve(this.mutationQueue.length===0?-1:this.Sr-1)}getAllMutationBatches(e){return k.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const r=new ve(t,0),s=new ve(t,Number.POSITIVE_INFINITY),o=[];return this.br.forEachInRange([r,s],a=>{const l=this.Dr(a.wr);o.push(l)}),k.resolve(o)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new we(Y);return t.forEach(s=>{const o=new ve(s,0),a=new ve(s,Number.POSITIVE_INFINITY);this.br.forEachInRange([o,a],l=>{r=r.add(l.wr)})}),k.resolve(this.Cr(r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,s=r.length+1;let o=r;F.isDocumentKey(o)||(o=o.child(""));const a=new ve(new F(o),0);let l=new we(Y);return this.br.forEachWhile(u=>{const d=u.key.path;return!!r.isPrefixOf(d)&&(d.length===s&&(l=l.add(u.wr)),!0)},a),k.resolve(this.Cr(l))}Cr(e){const t=[];return e.forEach(r=>{const s=this.Dr(r);s!==null&&t.push(s)}),t}removeMutationBatch(e,t){J(this.Fr(t.batchId,"removed")===0),this.mutationQueue.shift();let r=this.br;return k.forEach(t.mutations,s=>{const o=new ve(s.key,t.batchId);return r=r.delete(o),this.referenceDelegate.markPotentiallyOrphaned(e,s.key)}).next(()=>{this.br=r})}On(e){}containsKey(e,t){const r=new ve(t,0),s=this.br.firstAfterOrEqual(r);return k.resolve(t.isEqual(s&&s.key))}performConsistencyCheck(e){return this.mutationQueue.length,k.resolve()}Fr(e,t){return this.vr(e)}vr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Dr(e){const t=this.vr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jg{constructor(e){this.Mr=e,this.docs=function(){return new ce(F.comparator)}(),this.size=0}setIndexManager(e){this.indexManager=e}addEntry(e,t){const r=t.key,s=this.docs.get(r),o=s?s.size:0,a=this.Mr(t);return this.docs=this.docs.insert(r,{document:t.mutableCopy(),size:a}),this.size+=a-o,this.indexManager.addToCollectionParentIndex(e,r.path.popLast())}removeEntry(e){const t=this.docs.get(e);t&&(this.docs=this.docs.remove(e),this.size-=t.size)}getEntry(e,t){const r=this.docs.get(t);return k.resolve(r?r.document.mutableCopy():Ce.newInvalidDocument(t))}getEntries(e,t){let r=ht();return t.forEach(s=>{const o=this.docs.get(s);r=r.insert(s,o?o.document.mutableCopy():Ce.newInvalidDocument(s))}),k.resolve(r)}getDocumentsMatchingQuery(e,t,r,s){let o=ht();const a=t.path,l=new F(a.child("")),u=this.docs.getIteratorFrom(l);for(;u.hasNext();){const{key:d,value:{document:p}}=u.getNext();if(!a.isPrefixOf(d.path))break;d.path.length>a.length+1||x_(O_(p),r)<=0||(s.has(p.key)||Ms(t,p))&&(o=o.insert(p.key,p.mutableCopy()))}return k.resolve(o)}getAllFromCollectionGroup(e,t,r,s){$()}Or(e,t){return k.forEach(this.docs,r=>t(r))}newChangeBuffer(e){return new Zg(this)}getSize(e){return k.resolve(this.size)}}class Zg extends Wg{constructor(e){super(),this.cr=e}applyChanges(e){const t=[];return this.changes.forEach((r,s)=>{s.isValidDocument()?t.push(this.cr.addEntry(e,s)):this.cr.removeEntry(r)}),k.waitFor(t)}getFromCache(e,t){return this.cr.getEntry(e,t)}getAllFromCache(e,t){return this.cr.getEntries(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sy{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Ud()?8:F_(ke())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.Yi(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(e,t,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new ry;return this.Xi(e,t,a).next(l=>{if(o.result=l,this.zi)return this.es(e,t,a,l.size)})}).next(()=>o.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(Xn()<=H.DEBUG&&M("QueryEngine","SDK will not create cache indexes for query:",cn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),k.resolve()):(Xn()<=H.DEBUG&&M("QueryEngine","Query:",cn(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(Xn()<=H.DEBUG&&M("QueryEngine","The SDK decides to create cache indexes for query:",cn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Je(t))):k.resolve())}Yi(e,t){if(Mc(t))return k.resolve(null);let r=Je(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=zi(t,null,"F"),r=Je(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=W(...o);return this.Ji.getDocuments(e,a).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const d=this.ts(t,l);return this.ns(t,d,a,u.readTime)?this.Yi(e,zi(t,null,"F")):this.rs(e,d,t,u)}))})))}Zi(e,t,r,s){return Mc(t)||s.isEqual(q.min())?k.resolve(null):this.Ji.getDocuments(e,r).next(o=>{const a=this.ts(t,o);return this.ns(t,a,r,s)?k.resolve(null):(Xn()<=H.DEBUG&&M("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),cn(t)),this.rs(e,a,t,V_(s,-1)).next(l=>l))})}ts(e,t){let r=new we(Cu(e));return t.forEach((s,o)=>{Ms(e,o)&&(r=r.add(o))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Xi(e,t,r){return Xn()<=H.DEBUG&&M("QueryEngine","Using full collection scan to execute query:",cn(t)),this.Ji.getDocumentsMatchingQuery(e,t,St.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iy{constructor(e,t,r,s){this.persistence=e,this.ss=t,this.serializer=s,this.os=new ce(Y),this._s=new Cn(o=>yo(o),vo),this.us=new Map,this.cs=e.getRemoteDocumentCache(),this.Ur=e.getTargetCache(),this.Gr=e.getBundleCache(),this.ls(r)}ls(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new Hg(this.cs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.cs.setIndexManager(this.indexManager),this.ss.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.os))}}function oy(n,e,t,r){return new iy(n,e,t,r)}async function Xu(n,e){const t=z(n);return await t.persistence.runTransaction("Handle user change","readonly",r=>{let s;return t.mutationQueue.getAllMutationBatches(r).next(o=>(s=o,t.ls(e),t.mutationQueue.getAllMutationBatches(r))).next(o=>{const a=[],l=[];let u=W();for(const d of s){a.push(d.batchId);for(const p of d.mutations)u=u.add(p.key)}for(const d of o){l.push(d.batchId);for(const p of d.mutations)u=u.add(p.key)}return t.localDocuments.getDocuments(r,u).next(d=>({hs:d,removedBatchIds:a,addedBatchIds:l}))})})}function ay(n,e){const t=z(n);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",r=>{const s=e.batch.keys(),o=t.cs.newChangeBuffer({trackRemovals:!0});return function(l,u,d,p){const g=d.batch,w=g.keys();let S=k.resolve();return w.forEach(P=>{S=S.next(()=>p.getEntry(u,P)).next(N=>{const D=d.docVersions.get(P);J(D!==null),N.version.compareTo(D)<0&&(g.applyToRemoteDocument(N,d),N.isValidDocument()&&(N.setReadTime(d.commitVersion),p.addEntry(N)))})}),S.next(()=>l.mutationQueue.removeMutationBatch(u,g))}(t,r,e,o).next(()=>o.apply(r)).next(()=>t.mutationQueue.performConsistencyCheck(r)).next(()=>t.documentOverlayCache.removeOverlaysForBatchId(r,s,e.batch.batchId)).next(()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(r,function(l){let u=W();for(let d=0;d<l.mutationResults.length;++d)l.mutationResults[d].transformResults.length>0&&(u=u.add(l.batch.mutations[d].key));return u}(e))).next(()=>t.localDocuments.getDocuments(r,s))})}function Yu(n){const e=z(n);return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Ur.getLastRemoteSnapshotVersion(t))}function cy(n,e){const t=z(n),r=e.snapshotVersion;let s=t.os;return t.persistence.runTransaction("Apply remote event","readwrite-primary",o=>{const a=t.cs.newChangeBuffer({trackRemovals:!0});s=t.os;const l=[];e.targetChanges.forEach((p,g)=>{const w=s.get(g);if(!w)return;l.push(t.Ur.removeMatchingKeys(o,p.removedDocuments,g).next(()=>t.Ur.addMatchingKeys(o,p.addedDocuments,g)));let S=w.withSequenceNumber(o.currentSequenceNumber);e.targetMismatches.get(g)!==null?S=S.withResumeToken(Ae.EMPTY_BYTE_STRING,q.min()).withLastLimboFreeSnapshotVersion(q.min()):p.resumeToken.approximateByteSize()>0&&(S=S.withResumeToken(p.resumeToken,r)),s=s.insert(g,S),function(N,D,U){return N.resumeToken.approximateByteSize()===0||D.snapshotVersion.toMicroseconds()-N.snapshotVersion.toMicroseconds()>=3e8?!0:U.addedDocuments.size+U.modifiedDocuments.size+U.removedDocuments.size>0}(w,S,p)&&l.push(t.Ur.updateTargetData(o,S))});let u=ht(),d=W();if(e.documentUpdates.forEach(p=>{e.resolvedLimboDocuments.has(p)&&l.push(t.persistence.referenceDelegate.updateLimboDocument(o,p))}),l.push(ly(o,a,e.documentUpdates).next(p=>{u=p.Ps,d=p.Is})),!r.isEqual(q.min())){const p=t.Ur.getLastRemoteSnapshotVersion(o).next(g=>t.Ur.setTargetsMetadata(o,o.currentSequenceNumber,r));l.push(p)}return k.waitFor(l).next(()=>a.apply(o)).next(()=>t.localDocuments.getLocalViewOfDocuments(o,u,d)).next(()=>u)}).then(o=>(t.os=s,o))}function ly(n,e,t){let r=W(),s=W();return t.forEach(o=>r=r.add(o)),e.getEntries(n,r).next(o=>{let a=ht();return t.forEach((l,u)=>{const d=o.get(l);u.isFoundDocument()!==d.isFoundDocument()&&(s=s.add(l)),u.isNoDocument()&&u.version.isEqual(q.min())?(e.removeEntry(l,u.readTime),a=a.insert(l,u)):!d.isValidDocument()||u.version.compareTo(d.version)>0||u.version.compareTo(d.version)===0&&d.hasPendingWrites?(e.addEntry(u),a=a.insert(l,u)):M("LocalStore","Ignoring outdated watch update for ",l,". Current version:",d.version," Watch version:",u.version)}),{Ps:a,Is:s}})}function uy(n,e){const t=z(n);return t.persistence.runTransaction("Get next mutation batch","readonly",r=>(e===void 0&&(e=-1),t.mutationQueue.getNextMutationBatchAfterBatchId(r,e)))}function hy(n,e){const t=z(n);return t.persistence.runTransaction("Allocate target","readwrite",r=>{let s;return t.Ur.getTargetData(r,e).next(o=>o?(s=o,k.resolve(s)):t.Ur.allocateTargetId(r).next(a=>(s=new Tt(e,a,"TargetPurposeListen",r.currentSequenceNumber),t.Ur.addTargetData(r,s).next(()=>s))))}).then(r=>{const s=t.os.get(r.targetId);return(s===null||r.snapshotVersion.compareTo(s.snapshotVersion)>0)&&(t.os=t.os.insert(r.targetId,r),t._s.set(e,r.targetId)),r})}async function Qi(n,e,t){const r=z(n),s=r.os.get(e),o=t?"readwrite":"readwrite-primary";try{t||await r.persistence.runTransaction("Release target",o,a=>r.persistence.referenceDelegate.removeTarget(a,s))}catch(a){if(!kr(a))throw a;M("LocalStore",`Failed to update sequence numbers for target ${e}: ${a}`)}r.os=r.os.remove(e),r._s.delete(s.target)}function Kc(n,e,t){const r=z(n);let s=q.min(),o=W();return r.persistence.runTransaction("Execute query","readwrite",a=>function(u,d,p){const g=z(u),w=g._s.get(p);return w!==void 0?k.resolve(g.os.get(w)):g.Ur.getTargetData(d,p)}(r,a,Je(e)).next(l=>{if(l)return s=l.lastLimboFreeSnapshotVersion,r.Ur.getMatchingKeysForTargetId(a,l.targetId).next(u=>{o=u})}).next(()=>r.ss.getDocumentsMatchingQuery(a,e,t?s:q.min(),t?o:W())).next(l=>(dy(r,ng(e),l),{documents:l,Ts:o})))}function dy(n,e,t){let r=n.us.get(e)||q.min();t.forEach((s,o)=>{o.readTime.compareTo(r)>0&&(r=o.readTime)}),n.us.set(e,r)}class Qc{constructor(){this.activeTargetIds=cg()}fs(e){this.activeTargetIds=this.activeTargetIds.add(e)}gs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Vs(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class fy{constructor(){this.so=new Qc,this.oo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,r){}addLocalQueryTarget(e,t=!0){return t&&this.so.fs(e),this.oo[e]||"not-current"}updateQueryState(e,t,r){this.oo[e]=t}removeLocalQueryTarget(e){this.so.gs(e)}isLocalQueryTarget(e){return this.so.activeTargetIds.has(e)}clearQueryState(e){delete this.oo[e]}getAllActiveQueryTargets(){return this.so.activeTargetIds}isActiveQueryTarget(e){return this.so.activeTargetIds.has(e)}start(){return this.so=new Qc,Promise.resolve()}handleUserChange(e,t,r){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pe="WebChannelConnection";class gy extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${s}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${o}`}get Fo(){return!1}Mo(t,r,s,o,a){const l=Ai(),u=this.xo(t,r.toUriEncodedString());M("RestConnection",`Sending RPC '${t}' ${l}:`,u,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,o,a),this.No(t,u,d,s).then(p=>(M("RestConnection",`Received RPC '${t}' ${l}: `,p),p),p=>{throw mr("RestConnection",`RPC '${t}' ${l} failed with error: `,p,"url: ",u,"request:",s),p})}Lo(t,r,s,o,a,l){return this.Mo(t,r,s,o,a)}Oo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Sn}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>t[a]=o),s&&s.headers.forEach((o,a)=>t[a]=o)}xo(t,r){const s=my[t];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,s){const o=Ai();return new Promise((a,l)=>{const u=new du;u.setWithCredentials(!0),u.listenOnce(fu.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case cs.NO_ERROR:const p=u.getResponseJson();M(Pe,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),a(p);break;case cs.TIMEOUT:M(Pe,`RPC '${e}' ${o} timed out`),l(new L(C.DEADLINE_EXCEEDED,"Request time out"));break;case cs.HTTP_ERROR:const g=u.getStatus();if(M(Pe,`RPC '${e}' ${o} failed with status:`,g,"response text:",u.getResponseText()),g>0){let w=u.getResponseJson();Array.isArray(w)&&(w=w[0]);const S=w==null?void 0:w.error;if(S&&S.status&&S.message){const P=function(D){const U=D.toLowerCase().replace(/_/g,"-");return Object.values(C).indexOf(U)>=0?U:C.UNKNOWN}(S.status);l(new L(P,S.message))}else l(new L(C.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new L(C.UNAVAILABLE,"Connection failed."));break;default:$()}}finally{M(Pe,`RPC '${e}' ${o} completed.`)}});const d=JSON.stringify(s);M(Pe,`RPC '${e}' ${o} sending request:`,s),u.send(t,"POST",d,r,15)})}Bo(e,t,r){const s=Ai(),o=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=_u(),l=mu(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const p=o.join("");M(Pe,`Creating RPC '${e}' stream ${s}: ${p}`,u);const g=a.createWebChannel(p,u);let w=!1,S=!1;const P=new _y({Io:D=>{S?M(Pe,`Not sending because RPC '${e}' stream ${s} is closed:`,D):(w||(M(Pe,`Opening RPC '${e}' stream ${s} transport.`),g.open(),w=!0),M(Pe,`RPC '${e}' stream ${s} sending:`,D),g.send(D))},To:()=>g.close()}),N=(D,U,x)=>{D.listen(U,G=>{try{x(G)}catch(Z){setTimeout(()=>{throw Z},0)}})};return N(g,rr.EventType.OPEN,()=>{S||(M(Pe,`RPC '${e}' stream ${s} transport opened.`),P.yo())}),N(g,rr.EventType.CLOSE,()=>{S||(S=!0,M(Pe,`RPC '${e}' stream ${s} transport closed`),P.So())}),N(g,rr.EventType.ERROR,D=>{S||(S=!0,mr(Pe,`RPC '${e}' stream ${s} transport errored:`,D),P.So(new L(C.UNAVAILABLE,"The operation could not be completed")))}),N(g,rr.EventType.MESSAGE,D=>{var U;if(!S){const x=D.data[0];J(!!x);const G=x,Z=G.error||((U=G[0])===null||U===void 0?void 0:U.error);if(Z){M(Pe,`RPC '${e}' stream ${s} received error:`,Z);const ie=Z.status;let te=function(y){const E=me[y];if(E!==void 0)return ju(E)}(ie),T=Z.message;te===void 0&&(te=C.INTERNAL,T="Unknown error status: "+ie+" with message "+Z.message),S=!0,P.So(new L(te,T)),g.close()}else M(Pe,`RPC '${e}' stream ${s} received:`,x),P.bo(x)}}),N(l,pu.STAT_EVENT,D=>{D.stat===Fi.PROXY?M(Pe,`RPC '${e}' stream ${s} detected buffering proxy`):D.stat===Fi.NOPROXY&&M(Pe,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{P.wo()},0),P}}function Ri(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ey extends class{}{constructor(e,t,r,s){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=r,this.serializer=s,this.y_=!1}w_(){if(this.y_)throw new L(C.FAILED_PRECONDITION,"The client has already been terminated.")}Mo(e,t,r,s){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,a])=>this.connection.Mo(e,Gi(t,r),s,o,a)).catch(o=>{throw o.name==="FirebaseError"?(o.code===C.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new L(C.UNKNOWN,o.toString())})}Lo(e,t,r,s,o){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([a,l])=>this.connection.Lo(e,Gi(t,r),s,a,l,o)).catch(a=>{throw a.name==="FirebaseError"?(a.code===C.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),a):new L(C.UNKNOWN,a.toString())})}terminate(){this.y_=!0,this.connection.terminate()}}class Iy{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.S_=0,this.b_=null,this.D_=!0}v_(){this.S_===0&&(this.C_("Unknown"),this.b_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.b_=null,this.F_("Backend didn't respond within 10 seconds."),this.C_("Offline"),Promise.resolve())))}M_(e){this.state==="Online"?this.C_("Unknown"):(this.S_++,this.S_>=1&&(this.x_(),this.F_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.C_("Offline")))}set(e){this.x_(),this.S_=0,e==="Online"&&(this.D_=!1),this.C_(e)}C_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}F_(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jc{constructor(){this.W_=new ce(F.comparator)}track(e){const t=e.doc.key,r=this.W_.get(t);r?e.type!==0&&r.type===3?this.W_=this.W_.insert(t,e):e.type===3&&r.type!==1?this.W_=this.W_.insert(t,{type:r.type,doc:e.doc}):e.type===2&&r.type===2?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):e.type===2&&r.type===0?this.W_=this.W_.insert(t,{type:0,doc:e.doc}):e.type===1&&r.type===0?this.W_=this.W_.remove(t):e.type===1&&r.type===2?this.W_=this.W_.insert(t,{type:1,doc:r.doc}):e.type===0&&r.type===1?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):$():this.W_=this.W_.insert(t,e)}G_(){const e=[];return this.W_.inorderTraversal((t,r)=>{e.push(r)}),e}}class Tn{constructor(e,t,r,s,o,a,l,u,d){this.query=e,this.docs=t,this.oldDocs=r,this.docChanges=s,this.mutatedKeys=o,this.fromCache=a,this.syncStateChanged=l,this.excludesMetadataChanges=u,this.hasCachedResults=d}static fromInitialDocuments(e,t,r,s,o){const a=[];return t.forEach(l=>{a.push({type:0,doc:l})}),new Tn(e,t,mn.emptySet(t),a,r,s,!0,!1,o)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Ls(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,r=e.docChanges;if(t.length!==r.length)return!1;for(let s=0;s<t.length;s++)if(t[s].type!==r[s].type||!t[s].doc.isEqual(r[s].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oy{constructor(){this.z_=void 0,this.j_=[]}H_(){return this.j_.some(e=>e.J_())}}class xy{constructor(){this.queries=Zc(),this.onlineState="Unknown",this.Y_=new Set}terminate(){(function(t,r){const s=z(t),o=s.queries;s.queries=Zc(),o.forEach((a,l)=>{for(const u of l.j_)u.onError(r)})})(this,new L(C.ABORTED,"Firestore shutting down"))}}function Zc(){return new Cn(n=>Pu(n),Ls)}async function Ly(n,e){const t=z(n);let r=3;const s=e.query;let o=t.queries.get(s);o?!o.H_()&&e.J_()&&(r=2):(o=new Oy,r=e.J_()?0:1);try{switch(r){case 0:o.z_=await t.onListen(s,!0);break;case 1:o.z_=await t.onListen(s,!1);break;case 2:await t.onFirstRemoteStoreListen(s)}}catch(a){const l=Oo(a,`Initialization of query '${cn(e.query)}' failed`);return void e.onError(l)}t.queries.set(s,o),o.j_.push(e),e.Z_(t.onlineState),o.z_&&e.X_(o.z_)&&xo(t)}async function My(n,e){const t=z(n),r=e.query;let s=3;const o=t.queries.get(r);if(o){const a=o.j_.indexOf(e);a>=0&&(o.j_.splice(a,1),o.j_.length===0?s=e.J_()?0:1:!o.H_()&&e.J_()&&(s=2))}switch(s){case 0:return t.queries.delete(r),t.onUnlisten(r,!0);case 1:return t.queries.delete(r),t.onUnlisten(r,!1);case 2:return t.onLastRemoteStoreUnlisten(r);default:return}}function Fy(n,e){const t=z(n);let r=!1;for(const s of e){const o=s.query,a=t.queries.get(o);if(a){for(const l of a.j_)l.X_(s)&&(r=!0);a.z_=s}}r&&xo(t)}function Uy(n,e,t){const r=z(n),s=r.queries.get(e);if(s)for(const o of s.j_)o.onError(t);r.queries.delete(e)}function xo(n){n.Y_.forEach(e=>{e.next()})}var Xi,el;(el=Xi||(Xi={})).ea="default",el.Cache="cache";class jy{constructor(e,t,r){this.query=e,this.ta=t,this.na=!1,this.ra=null,this.onlineState="Unknown",this.options=r||{}}X_(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new Tn(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.na?this.ia(e)&&(this.ta.next(e),t=!0):this.sa(e,this.onlineState)&&(this.oa(e),t=!0),this.ra=e,t}onError(e){this.ta.error(e)}Z_(e){this.onlineState=e;let t=!1;return this.ra&&!this.na&&this.sa(this.ra,e)&&(this.oa(this.ra),t=!0),t}sa(e,t){if(!e.fromCache||!this.J_())return!0;const r=t!=="Offline";return(!this.options._a||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}ia(e){if(e.docChanges.length>0)return!0;const t=this.ra&&this.ra.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}oa(e){e=Tn.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.na=!0,this.ta.next(e)}J_(){return this.options.source!==Xi.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oh{constructor(e){this.key=e}}class ah{constructor(e){this.key=e}}class By{constructor(e,t){this.query=e,this.Ta=t,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=W(),this.mutatedKeys=W(),this.Aa=Cu(e),this.Ra=new mn(this.Aa)}get Va(){return this.Ta}ma(e,t){const r=t?t.fa:new Jc,s=t?t.Ra:this.Ra;let o=t?t.mutatedKeys:this.mutatedKeys,a=s,l=!1;const u=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,d=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal((p,g)=>{const w=s.get(p),S=Ms(this.query,g)?g:null,P=!!w&&this.mutatedKeys.has(w.key),N=!!S&&(S.hasLocalMutations||this.mutatedKeys.has(S.key)&&S.hasCommittedMutations);let D=!1;w&&S?w.data.isEqual(S.data)?P!==N&&(r.track({type:3,doc:S}),D=!0):this.ga(w,S)||(r.track({type:2,doc:S}),D=!0,(u&&this.Aa(S,u)>0||d&&this.Aa(S,d)<0)&&(l=!0)):!w&&S?(r.track({type:0,doc:S}),D=!0):w&&!S&&(r.track({type:1,doc:w}),D=!0,(u||d)&&(l=!0)),D&&(S?(a=a.add(S),o=N?o.add(p):o.delete(p)):(a=a.delete(p),o=o.delete(p)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const p=this.query.limitType==="F"?a.last():a.first();a=a.delete(p.key),o=o.delete(p.key),r.track({type:1,doc:p})}return{Ra:a,fa:r,ns:l,mutatedKeys:o}}ga(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,s){const o=this.Ra;this.Ra=e.Ra,this.mutatedKeys=e.mutatedKeys;const a=e.fa.G_();a.sort((p,g)=>function(S,P){const N=D=>{switch(D){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return $()}};return N(S)-N(P)}(p.type,g.type)||this.Aa(p.doc,g.doc)),this.pa(r),s=s!=null&&s;const l=t&&!s?this.ya():[],u=this.da.size===0&&this.current&&!s?1:0,d=u!==this.Ea;return this.Ea=u,a.length!==0||d?{snapshot:new Tn(this.query,e.Ra,o,a,e.mutatedKeys,u===0,d,!1,!!r&&r.resumeToken.approximateByteSize()>0),wa:l}:{wa:l}}Z_(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new Jc,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(e){return!this.Ta.has(e)&&!!this.Ra.has(e)&&!this.Ra.get(e).hasLocalMutations}pa(e){e&&(e.addedDocuments.forEach(t=>this.Ta=this.Ta.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ta=this.Ta.delete(t)),this.current=e.current)}ya(){if(!this.current)return[];const e=this.da;this.da=W(),this.Ra.forEach(r=>{this.Sa(r.key)&&(this.da=this.da.add(r.key))});const t=[];return e.forEach(r=>{this.da.has(r)||t.push(new ah(r))}),this.da.forEach(r=>{e.has(r)||t.push(new oh(r))}),t}ba(e){this.Ta=e.Ts,this.da=W();const t=this.ma(e.documents);return this.applyChanges(t,!0)}Da(){return Tn.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,this.Ea===0,this.hasCachedResults)}}class $y{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class qy{constructor(e){this.key=e,this.va=!1}}class zy{constructor(e,t,r,s,o,a){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=s,this.currentUser=o,this.maxConcurrentLimboResolutions=a,this.Ca={},this.Fa=new Cn(l=>Pu(l),Ls),this.Ma=new Map,this.xa=new Set,this.Oa=new ce(F.comparator),this.Na=new Map,this.La=new bo,this.Ba={},this.ka=new Map,this.qa=In.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return this.Qa===!0}}async function Wy(n,e,t=!0){const r=fh(n);let s;const o=r.Fa.get(e);return o?(r.sharedClientState.addLocalQueryTarget(o.targetId),s=o.view.Da()):s=await ch(r,e,t,!0),s}async function Gy(n,e){const t=fh(n);await ch(t,e,!0,!1)}async function ch(n,e,t,r){const s=await hy(n.localStore,Je(e)),o=s.targetId,a=n.sharedClientState.addLocalQueryTarget(o,t);let l;return r&&(l=await Hy(n,e,o,a==="current",s.resumeToken)),n.isPrimaryClient&&t&&eh(n.remoteStore,s),l}async function Hy(n,e,t,r,s){n.Ka=(g,w,S)=>async function(N,D,U,x){let G=D.view.ma(U);G.ns&&(G=await Kc(N.localStore,D.query,!1).then(({documents:T})=>D.view.ma(T,G)));const Z=x&&x.targetChanges.get(D.targetId),ie=x&&x.targetMismatches.get(D.targetId)!=null,te=D.view.applyChanges(G,N.isPrimaryClient,Z,ie);return nl(N,D.targetId,te.wa),te.snapshot}(n,g,w,S);const o=await Kc(n.localStore,e,!0),a=new By(e,o.Ts),l=a.ma(o.documents),u=Dr.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",s),d=a.applyChanges(l,n.isPrimaryClient,u);nl(n,t,d.wa);const p=new $y(e,t,a);return n.Fa.set(e,p),n.Ma.has(t)?n.Ma.get(t).push(e):n.Ma.set(t,[e]),d.snapshot}async function Ky(n,e,t){const r=z(n),s=r.Fa.get(e),o=r.Ma.get(s.targetId);if(o.length>1)return r.Ma.set(s.targetId,o.filter(a=>!Ls(a,e))),void r.Fa.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await Qi(r.localStore,s.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(s.targetId),t&&Co(r.remoteStore,s.targetId),Yi(r,s.targetId)}).catch(Cr)):(Yi(r,s.targetId),await Qi(r.localStore,s.targetId,!0))}async function Qy(n,e){const t=z(n),r=t.Fa.get(e),s=t.Ma.get(r.targetId);t.isPrimaryClient&&s.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),Co(t.remoteStore,r.targetId))}async function Xy(n,e,t){const r=rv(n);try{const s=await function(a,l){const u=z(a),d=pe.now(),p=l.reduce((S,P)=>S.add(P.key),W());let g,w;return u.persistence.runTransaction("Locally write mutations","readwrite",S=>{let P=ht(),N=W();return u.cs.getEntries(S,p).next(D=>{P=D,P.forEach((U,x)=>{x.isValidDocument()||(N=N.add(U))})}).next(()=>u.localDocuments.getOverlayedDocuments(S,P)).next(D=>{g=D;const U=[];for(const x of l){const G=mg(x,g.get(x.key).overlayedDocument);G!=null&&U.push(new Nt(x.key,G,Eu(G.value.mapValue),ze.exists(!0)))}return u.mutationQueue.addMutationBatch(S,d,U,l)}).next(D=>{w=D;const U=D.applyToLocalDocumentSet(g,N);return u.documentOverlayCache.saveOverlays(S,D.batchId,U)})}).then(()=>({batchId:w.batchId,changes:Nu(g)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),function(a,l,u){let d=a.Ba[a.currentUser.toKey()];d||(d=new ce(Y)),d=d.insert(l,u),a.Ba[a.currentUser.toKey()]=d}(r,s.batchId,t),await Or(r,s.changes),await qs(r.remoteStore)}catch(s){const o=Oo(s,"Failed to persist write");t.reject(o)}}async function lh(n,e){const t=z(n);try{const r=await cy(t.localStore,e);e.targetChanges.forEach((s,o)=>{const a=t.Na.get(o);a&&(J(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1),s.addedDocuments.size>0?a.va=!0:s.modifiedDocuments.size>0?J(a.va):s.removedDocuments.size>0&&(J(a.va),a.va=!1))}),await Or(t,r,e)}catch(r){await Cr(r)}}function tl(n,e,t){const r=z(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const s=[];r.Fa.forEach((o,a)=>{const l=a.view.Z_(e);l.snapshot&&s.push(l.snapshot)}),function(a,l){const u=z(a);u.onlineState=l;let d=!1;u.queries.forEach((p,g)=>{for(const w of g.j_)w.Z_(l)&&(d=!0)}),d&&xo(u)}(r.eventManager,e),s.length&&r.Ca.d_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function Yy(n,e,t){const r=z(n);r.sharedClientState.updateQueryState(e,"rejected",t);const s=r.Na.get(e),o=s&&s.key;if(o){let a=new ce(F.comparator);a=a.insert(o,Ce.newNoDocument(o,q.min()));const l=W().add(o),u=new js(q.min(),new Map,new ce(Y),a,l);await lh(r,u),r.Oa=r.Oa.remove(o),r.Na.delete(e),Lo(r)}else await Qi(r.localStore,e,!1).then(()=>Yi(r,e,t)).catch(Cr)}async function Jy(n,e){const t=z(n),r=e.batch.batchId;try{const s=await ay(t.localStore,e);hh(t,r,null),uh(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await Or(t,s)}catch(s){await Cr(s)}}async function Zy(n,e,t){const r=z(n);try{const s=await function(a,l){const u=z(a);return u.persistence.runTransaction("Reject batch","readwrite-primary",d=>{let p;return u.mutationQueue.lookupMutationBatch(d,l).next(g=>(J(g!==null),p=g.keys(),u.mutationQueue.removeMutationBatch(d,g))).next(()=>u.mutationQueue.performConsistencyCheck(d)).next(()=>u.documentOverlayCache.removeOverlaysForBatchId(d,p,l)).next(()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,p)).next(()=>u.localDocuments.getDocuments(d,p))})}(r.localStore,e);hh(r,e,t),uh(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await Or(r,s)}catch(s){await Cr(s)}}function uh(n,e){(n.ka.get(e)||[]).forEach(t=>{t.resolve()}),n.ka.delete(e)}function hh(n,e,t){const r=z(n);let s=r.Ba[r.currentUser.toKey()];if(s){const o=s.get(e);o&&(t?o.reject(t):o.resolve(),s=s.remove(e)),r.Ba[r.currentUser.toKey()]=s}}function Yi(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Ma.get(e))n.Fa.delete(r),t&&n.Ca.$a(r,t);n.Ma.delete(e),n.isPrimaryClient&&n.La.gr(e).forEach(r=>{n.La.containsKey(r)||dh(n,r)})}function dh(n,e){n.xa.delete(e.path.canonicalString());const t=n.Oa.get(e);t!==null&&(Co(n.remoteStore,t),n.Oa=n.Oa.remove(e),n.Na.delete(t),Lo(n))}function nl(n,e,t){for(const r of t)r instanceof oh?(n.La.addReference(r.key,e),ev(n,r)):r instanceof ah?(M("SyncEngine","Document no longer in limbo: "+r.key),n.La.removeReference(r.key,e),n.La.containsKey(r.key)||dh(n,r.key)):$()}function ev(n,e){const t=e.key,r=t.path.canonicalString();n.Oa.get(t)||n.xa.has(r)||(M("SyncEngine","New document in limbo: "+t),n.xa.add(r),Lo(n))}function Lo(n){for(;n.xa.size>0&&n.Oa.size<n.maxConcurrentLimboResolutions;){const e=n.xa.values().next().value;n.xa.delete(e);const t=new F(se.fromString(e)),r=n.qa.next();n.Na.set(r,new qy(t)),n.Oa=n.Oa.insert(t,r),eh(n.remoteStore,new Tt(Je(Eo(t.path)),r,"TargetPurposeLimboResolution",po.oe))}}async function Or(n,e,t){const r=z(n),s=[],o=[],a=[];r.Fa.isEmpty()||(r.Fa.forEach((l,u)=>{a.push(r.Ka(u,e,t).then(d=>{var p;if((d||t)&&r.isPrimaryClient){const g=d?!d.fromCache:(p=t==null?void 0:t.targetChanges.get(u.targetId))===null||p===void 0?void 0:p.current;r.sharedClientState.updateQueryState(u.targetId,g?"current":"not-current")}if(d){s.push(d);const g=Po.Wi(u.targetId,d);o.push(g)}}))}),await Promise.all(a),r.Ca.d_(s),await async function(u,d){const p=z(u);try{await p.persistence.runTransaction("notifyLocalViewChanges","readwrite",g=>k.forEach(d,w=>k.forEach(w.$i,S=>p.persistence.referenceDelegate.addReference(g,w.targetId,S)).next(()=>k.forEach(w.Ui,S=>p.persistence.referenceDelegate.removeReference(g,w.targetId,S)))))}catch(g){if(!kr(g))throw g;M("LocalStore","Failed to update sequence numbers: "+g)}for(const g of d){const w=g.targetId;if(!g.fromCache){const S=p.os.get(w),P=S.snapshotVersion,N=S.withLastLimboFreeSnapshotVersion(P);p.os=p.os.insert(w,N)}}}(r.localStore,o))}async function tv(n,e){const t=z(n);if(!t.currentUser.isEqual(e)){M("SyncEngine","User change. New user:",e.toKey());const r=await Xu(t.localStore,e);t.currentUser=e,function(o,a){o.ka.forEach(l=>{l.forEach(u=>{u.reject(new L(C.CANCELLED,a))})}),o.ka.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await Or(t,r.hs)}}function nv(n,e){const t=z(n),r=t.Na.get(e);if(r&&r.va)return W().add(r.key);{let s=W();const o=t.Ma.get(e);if(!o)return s;for(const a of o){const l=t.Fa.get(a);s=s.unionWith(l.view.Va)}return s}}function fh(n){const e=z(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=lh.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=nv.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=Yy.bind(null,e),e.Ca.d_=Fy.bind(null,e.eventManager),e.Ca.$a=Uy.bind(null,e.eventManager),e}function rv(n){const e=z(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=Jy.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=Zy.bind(null,e),e}class Ss{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Bs(e.databaseInfo.databaseId),this.sharedClientState=this.Wa(e),this.persistence=this.Ga(e),await this.persistence.start(),this.localStore=this.za(e),this.gcScheduler=this.ja(e,this.localStore),this.indexBackfillerScheduler=this.Ha(e,this.localStore)}ja(e,t){return null}Ha(e,t){return null}za(e){return oy(this.persistence,new sy,e.initialUser,this.serializer)}Ga(e){return new ty(So.Zr,this.serializer)}Wa(e){return new fy}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Ss.provider={build:()=>new Ss};class Ji{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>tl(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=tv.bind(null,this.syncEngine),await Vy(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new xy}()}createDatastore(e){const t=Bs(e.databaseInfo.databaseId),r=function(o){return new gy(o)}(e.databaseInfo);return function(o,a,l,u){return new Ey(o,a,l,u)}(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return function(r,s,o,a,l){return new Ty(r,s,o,a,l)}(this.localStore,this.datastore,e.asyncQueue,t=>tl(this.syncEngine,t,0),function(){return Xc.D()?new Xc:new py}())}createSyncEngine(e,t){return function(s,o,a,l,u,d,p){const g=new zy(s,o,a,l,u,d);return p&&(g.Qa=!0),g}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(s){const o=z(s);M("RemoteStore","RemoteStore shutting down."),o.L_.add(5),await Vr(o),o.k_.shutdown(),o.q_.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}Ji.provider={build:()=>new Ji};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new en(this.firestore,e,this._query)}}class Fe{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new bt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Fe(this.firestore,e,this._key)}}class bt extends en{constructor(e,t,r){super(e,t,Eo(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Fe(this.firestore,null,new F(e))}withConverter(e){return new bt(this.firestore,e,this._path)}}function ll(n,e,...t){if(n=ge(n),_h("collection","path",e),n instanceof Mo){const r=se.fromString(e,...t);return al(r),new bt(n,null,r)}{if(!(n instanceof Fe||n instanceof bt))throw new L(C.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(se.fromString(e,...t));return al(r),new bt(n.firestore,null,r)}}function ds(n,e,...t){if(n=ge(n),arguments.length===1&&(e=gu.newId()),_h("doc","path",e),n instanceof Mo){const r=se.fromString(e,...t);return ol(r),new Fe(n,null,new F(r))}{if(!(n instanceof Fe||n instanceof bt))throw new L(C.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(se.fromString(e,...t));return ol(r),new Fe(n.firestore,n instanceof bt?n.converter:null,new F(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class An{constructor(e){this._byteString=e}static fromBase64String(e){try{return new An(Ae.fromBase64String(e))}catch(t){throw new L(C.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new An(Ae.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ws{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new L(C.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Te(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uo{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new L(C.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new L(C.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return Y(this._lat,e._lat)||Y(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Iv(n){if(n.limitType==="L"&&n.explicitOrderBy.length===0)throw new L(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Go{}class Ah extends Go{}function Tv(n,e,...t){let r=[];e instanceof Go&&r.push(e),r=r.concat(t),function(o){const a=o.filter(u=>u instanceof Ko).length,l=o.filter(u=>u instanceof Ho).length;if(a>1||a>0&&l>0)throw new L(C.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r);for(const s of r)n=s._apply(n);return n}class Ho extends Ah{constructor(e,t,r){super(),this._field=e,this._op=t,this._value=r,this.type="where"}static _create(e,t,r){return new Ho(e,t,r)}_apply(e){const t=this._parse(e);return Rh(e._query,t),new en(e.firestore,e.converter,qi(e._query,t))}_parse(e){const t=$o(e.firestore);return function(o,a,l,u,d,p,g){let w;if(d.isKeyField()){if(p==="array-contains"||p==="array-contains-any")throw new L(C.INVALID_ARGUMENT,`Invalid Query. You can't perform '${p}' queries on documentId().`);if(p==="in"||p==="not-in"){fl(g,p);const S=[];for(const P of g)S.push(dl(u,o,P));w={arrayValue:{values:S}}}else w=dl(u,o,g)}else p!=="in"&&p!=="not-in"&&p!=="array-contains-any"||fl(g,p),w=yv(l,a,g,p==="in"||p==="not-in");return _e.create(d,p,w)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value)}}class Ko extends Go{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new Ko(e,t)}_parse(e){const t=this._queryConstraints.map(r=>r._parse(e)).filter(r=>r.getFilters().length>0);return t.length===1?t[0]:Ge.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return t.getFilters().length===0?e:(function(s,o){let a=s;const l=o.getFlattenedFilters();for(const u of l)Rh(a,u),a=qi(a,u)}(e._query,t),new en(e.firestore,e.converter,qi(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}class Qo extends Ah{constructor(e,t){super(),this._field=e,this._direction=t,this.type="orderBy"}static _create(e,t){return new Qo(e,t)}_apply(e){const t=function(s,o,a){if(s.startAt!==null)throw new L(C.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(s.endAt!==null)throw new L(C.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new Er(o,a)}(e._query,this._field,this._direction);return new en(e.firestore,e.converter,function(s,o){const a=s.explicitOrderBy.concat([o]);return new Pn(s.path,s.collectionGroup,a,s.filters.slice(),s.limit,s.limitType,s.startAt,s.endAt)}(e._query,t))}}function wv(n,e="asc"){const t=e,r=Wo("orderBy",n);return Qo._create(r,t)}function dl(n,e,t){if(typeof(t=ge(t))=="string"){if(t==="")throw new L(C.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!Su(e)&&t.indexOf("/")!==-1)throw new L(C.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${t}' contains a '/' character.`);const r=e.path.child(se.fromString(t));if(!F.isDocumentKey(r))throw new L(C.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return Nc(n,new F(r))}if(t instanceof Fe)return Nc(n,t._key);throw new L(C.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${zs(t)}.`)}function fl(n,e){if(!Array.isArray(n)||n.length===0)throw new L(C.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function Rh(n,e){const t=function(s,o){for(const a of s)for(const l of a.getFlattenedFilters())if(o.indexOf(l.op)>=0)return l.op;return null}(n.filters,function(s){switch(s){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(t!==null)throw t===e.op?new L(C.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new L(C.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${t.toString()}' filters.`)}class Av{convertValue(e,t="none"){switch(Yt(e)){case 0:return null;case 1:return e.booleanValue;case 2:return fe(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(Xt(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 11:return this.convertObject(e.mapValue,t);case 10:return this.convertVectorValue(e.mapValue);default:throw $()}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const r={};return Jt(e,(s,o)=>{r[s]=this.convertValue(o,t)}),r}convertVectorValue(e){var t,r,s;const o=(s=(r=(t=e.fields)===null||t===void 0?void 0:t.value.arrayValue)===null||r===void 0?void 0:r.values)===null||s===void 0?void 0:s.map(a=>fe(a.doubleValue));return new jo(o)}convertGeoPoint(e){return new Uo(fe(e.latitude),fe(e.longitude))}convertArray(e,t){return(e.values||[]).map(r=>this.convertValue(r,t))}convertServerTimestamp(e,t){switch(t){case"previous":const r=_o(e);return r==null?null:this.convertValue(r,t);case"estimate":return this.convertTimestamp(gr(e));default:return null}}convertTimestamp(e){const t=Pt(e);return new pe(t.seconds,t.nanos)}convertDocumentKey(e,t){const r=se.fromString(e);J(Qu(r));const s=new yr(r.get(1),r.get(3)),o=new F(r.popFirst(5));return s.isEqual(t)||ut(`Document ${o} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),o}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class or{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class bh extends wh{constructor(e,t,r,s,o,a){super(e,t,r,s,a),this._firestore=e,this._firestoreImpl=e,this.metadata=o}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new fs(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const r=this._document.data.field(Wo("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}}class fs extends bh{data(e={}){return super.data(e)}}class bv{constructor(e,t,r,s){this._firestore=e,this._userDataWriter=t,this._snapshot=s,this.metadata=new or(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,t){this._snapshot.docs.forEach(r=>{e.call(t,new fs(this._firestore,this._userDataWriter,r.key,r,new or(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new L(C.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(s,o){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(l=>{const u=new fs(s._firestore,s._userDataWriter,l.doc.key,l.doc,new or(s._snapshot.mutatedKeys.has(l.doc.key),s._snapshot.fromCache),s.query.converter);return l.doc,{type:"added",doc:u,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(l=>o||l.type!==3).map(l=>{const u=new fs(s._firestore,s._userDataWriter,l.doc.key,l.doc,new or(s._snapshot.mutatedKeys.has(l.doc.key),s._snapshot.fromCache),s.query.converter);let d=-1,p=-1;return l.type!==0&&(d=a.indexOf(l.doc.key),a=a.delete(l.doc.key)),l.type!==1&&(a=a.add(l.doc),p=a.indexOf(l.doc.key)),{type:Sv(l.type),doc:u,oldIndex:d,newIndex:p}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function Sv(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return $()}}class Sh extends Av{constructor(e){super(),this.firestore=e}convertBytes(e){return new An(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Fe(this.firestore,null,t)}}function Pv(n,e,t,...r){n=zt(n,Fe);const s=zt(n.firestore,wn),o=$o(s);let a;return a=typeof(e=ge(e))=="string"||e instanceof Ws?gv(o,"updateDoc",n._key,e,t,r):_v(o,"updateDoc",n._key,e),Xo(s,[a.toMutation(n._key,ze.exists(!0))])}function pl(n){return Xo(zt(n.firestore,wn),[new To(n._key,ze.none())])}function Cv(n,e){const t=zt(n.firestore,wn),r=ds(n),s=Rv(n.converter,e);return Xo(t,[mv($o(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,ze.exists(!1))]).then(()=>r)}function kv(n,...e){var t,r,s;n=ge(n);let o={includeMetadataChanges:!1,source:"default"},a=0;typeof e[a]!="object"||hl(e[a])||(o=e[a],a++);const l={includeMetadataChanges:o.includeMetadataChanges,source:o.source};if(hl(e[a])){const g=e[a];e[a]=(t=g.next)===null||t===void 0?void 0:t.bind(g),e[a+1]=(r=g.error)===null||r===void 0?void 0:r.bind(g),e[a+2]=(s=g.complete)===null||s===void 0?void 0:s.bind(g)}let u,d,p;if(n instanceof Fe)d=zt(n.firestore,wn),p=Eo(n._key.path),u={next:g=>{e[a]&&e[a](Nv(d,n,g))},error:e[a+1],complete:e[a+2]};else{const g=zt(n,en);d=zt(g.firestore,wn),p=g._query;const w=new Sh(d);u={next:S=>{e[a]&&e[a](new bv(d,w,g,S))},error:e[a+1],complete:e[a+2]},Iv(n._query)}return function(w,S,P,N){const D=new sv(N),U=new jy(S,D,P);return w.asyncQueue.enqueueAndForget(async()=>Ly(await sl(w),U)),()=>{D.Za(),w.asyncQueue.enqueueAndForget(async()=>My(await sl(w),U))}}(gh(d),p,l,u)}function Xo(n,e){return function(r,s){const o=new qt;return r.asyncQueue.enqueueAndForget(async()=>Xy(await av(r),s,o)),o.promise}(gh(n),e)}function Nv(n,e,t){const r=t.docs.get(e._key),s=new Sh(n);return new bh(n,s,e._key,r,new or(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){(function(s){Sn=s})(Rn),_n(new Gt("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),l=new wn(new b_(r.getProvider("auth-internal")),new k_(r.getProvider("app-check-internal")),function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new L(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new yr(d.options.projectId,p)}(a,s),a);return o=Object.assign({useFetchStreams:t},o),l._setSettings(o),l},"PUBLIC").setMultipleInstances(!0)),Rt(bc,"4.7.3",e),Rt(bc,"4.7.3","esm2017")})();const Dv={apiKey:"AIzaSyDS8jEcdPzYcDiDRZpvopMM6qxX1t6nNzU",authDomain:"order-management-62810.firebaseapp.com",projectId:"order-management-62810",storageBucket:"order-management-62810.firebasestorage.app",messagingSenderId:"593654538436",appId:"1:593654538436:web:322125e0c1bba4f0086991"},Ph=Pl(Dv),Yn=E_(Ph),Jn=uv(Ph,{cacheSizeBytes:lv});function Vv(){var l,u,d;const[n,e]=V.useState({user:null,loading:!0,error:null});V.useEffect(()=>{const p=cm(Yn,g=>{e({user:g,loading:!1,error:null})},g=>{e({user:null,loading:!1,error:g.message})});return()=>p()},[]);const t=V.useCallback(async(p,g,w)=>{try{e(P=>({...P,loading:!0,error:null}));const S=await nm(Yn,p,g);return w&&S.user&&await im(S.user,{displayName:w}),e({user:S.user,loading:!1,error:null}),S.user}catch(S){const P=Si(S.code);throw e(N=>({...N,loading:!1,error:P})),new Error(P)}},[]),r=V.useCallback(async(p,g)=>{try{e(S=>({...S,loading:!0,error:null}));const w=await rm(Yn,p,g);return e({user:w.user,loading:!1,error:null}),w.user}catch(w){const S=Si(w.code);throw e(P=>({...P,loading:!1,error:S})),new Error(S)}},[]),s=V.useCallback(async()=>{try{await lm(Yn),e({user:null,loading:!1,error:null})}catch(p){throw e(g=>({...g,error:p.message})),p}},[]),o=V.useCallback(async p=>{try{await tm(Yn,p)}catch(g){const w=Si(g.code);throw new Error(w)}},[]),a=V.useCallback(()=>{e(p=>({...p,error:null}))},[]);return{...n,register:t,login:r,logout:s,resetPassword:o,clearError:a,isLoggedIn:!!n.user,userId:((l=n.user)==null?void 0:l.uid)||null,displayName:((u=n.user)==null?void 0:u.displayName)||((d=n.user)==null?void 0:d.email)||null}}function Si(n){return{"auth/email-already-in-use":"该邮箱已被注册","auth/invalid-email":"邮箱格式不正确","auth/operation-not-allowed":"该登录方式未启用","auth/weak-password":"密码太弱，请使用至少6位密码","auth/user-disabled":"该账号已被禁用","auth/user-not-found":"该邮箱未注册","auth/wrong-password":"密码错误","auth/invalid-credential":"邮箱或密码错误","auth/too-many-requests":"登录失败次数过多，请稍后再试","auth/network-request-failed":"网络连接失败"}[n]||"操作失败，请重试"}function Ov(n){const[e,t]=V.useState([]),[r,s]=V.useState({}),[o,a]=V.useState({syncing:!1,lastSync:null,error:null});V.useEffect(()=>{if(!n){t([]),s({});return}a(U=>({...U,syncing:!0}));const P=ll(Jn,"users",n,"orders"),N=Tv(P,wv("entryDate","desc")),D=kv(N,U=>{const x=[],G={};U.forEach(Z=>{const ie=Z.data(),te=ie.id||Z.id;x.push({id:te,amount:ie.amount,agent:ie.agent,received:ie.received,receiveDate:ie.receiveDate,entryDate:ie.entryDate,remark:ie.remark||"",paid:ie.paid||!1,paidDate:ie.paidDate||null}),G[te]=Z.id}),t(x),s(G),a({syncing:!1,lastSync:new Date,error:null})},U=>{console.error("Firestore sync error:",U),a(x=>({...x,syncing:!1,error:"同步失败，请检查网络连接"}))});return()=>D()},[n]),V.useCallback(P=>r[P]||P,[r]);const l=V.useCallback(async P=>{if(!n)throw new Error("请先登录");const N=ll(Jn,"users",n,"orders");await Cv(N,{...P,createdAt:pe.now()})},[n]),u=V.useCallback(async(P,N)=>{if(!n)throw new Error("请先登录");const D=r[P]||P,U=ds(Jn,"users",n,"orders",D);await Pv(U,{...N,updatedAt:pe.now()})},[n,r]),d=V.useCallback(async P=>{if(!n)throw new Error("请先登录");const N=r[P]||P,D=ds(Jn,"users",n,"orders",N);await pl(D)},[n,r]),p=V.useCallback(async P=>{if(!n)throw new Error("请先登录");const N=P.map(D=>{const U=r[D]||D,x=ds(Jn,"users",n,"orders",U);return pl(x)});await Promise.all(N)},[n,r]),g=V.useCallback(async(P,N)=>{await u(P,{received:!0,receiveDate:N})},[u]),w=V.useCallback(async(P,N)=>{await u(P,{paid:!0,paidDate:N})},[u]),S=V.useCallback(async(P,N)=>{await u(P,{remark:N})},[u]);return{orders:e,syncState:o,addOrder:l,updateOrder:u,deleteOrder:d,batchDelete:p,markReceived:g,markPaid:w,updateRemark:S}}function Wt(){const n=new Date;return`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}-${String(n.getDate()).padStart(2,"0")}`}function ml(n){const[e,t,r]=n.split("-").map(Number);return new Date(e,t-1,r)}function Ch(){const n=new Date,e=n.getFullYear(),t=n.getMonth(),r=n.getDate();let s;return r<16?s=new Date(e,t,16):s=new Date(e,t+1,1),`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`}function kh(n){if(!n.received||!n.receiveDate||n.paid)return!1;const e=new Date(ml(n.receiveDate));e.setDate(e.getDate()+7);const t=new Date(ml(Ch()));return e<=t}function Cs(n){if(!n)return"—";const[,e,t]=n.split("-");return`${e}月${t}日`}function xv(n){return n.trim()?/^\d{6}-\d{15}$/.test(n.trim())?{valid:!0,message:""}:{valid:!1,message:"订单号格式应为：YYMMDD-XXXXXXXXXXXXXXX"}:{valid:!1,message:"订单号不能为空"}}function Lv(n){if(!n)return{valid:!1,message:"金额不能为空"};const e=Number(n);return isNaN(e)||e<=0?{valid:!1,message:"请输入有效的正数金额"}:{valid:!0,message:""}}function Mv(n,e,t){return n.filter(r=>{const s=e==="all"||(e==="received"?r.received:!r.received),o=t.toLowerCase(),a=r.id.toLowerCase().includes(o)||r.agent.includes(t)||(r.remark||"").toLowerCase().includes(o);return s&&a})}function Fv(n){const e=["订单号","金额（¥）","客服","收货状态","收货日期","收款状态","收款日期","录入日期","备注"],t=n.map(l=>[l.id,l.amount.toString(),l.agent,l.received?"已收货":"未收货",l.receiveDate||"",l.paid?"已收款":"未收款",l.paidDate||"",l.entryDate||"历史",l.remark||""]),r=[e,...t].map(l=>l.map(u=>`"${String(u).replace(/"/g,'""')}"`).join(",")).join(`
`),s=new Blob(["\uFEFF"+r],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(s),a=document.createElement("a");a.href=o,a.download=`订单台账_${Wt()}.csv`,a.click(),URL.revokeObjectURL(o)}function Uv(n,e,t){const r=V.useMemo(()=>Mv(n,e,t),[n,e,t]),s=V.useMemo(()=>r.filter(d=>!d.paid),[r]),o=V.useMemo(()=>r.filter(d=>d.paid),[r]),a=V.useMemo(()=>{const d=n.length,p=n.reduce((N,D)=>N+D.amount,0),g=n.filter(N=>N.received&&!N.paid).reduce((N,D)=>N+D.amount,0),w=n.filter(N=>N.paid).reduce((N,D)=>N+D.amount,0),S=Ch(),P=n.filter(N=>kh(N)&&N.receiveDate===S).reduce((N,D)=>N+D.amount,0);return{totalOrders:d,totalAmount:p,receivedAmount:g,paidAmount:w,settleableAmount:P,nextDateStr:S||"-"}},[n]),l=V.useMemo(()=>{const d={};return s.forEach((p,g)=>{p.agent in d||(d[p.agent]=g)}),d},[s]),u=V.useMemo(()=>{const d={};return o.forEach((p,g)=>{p.agent in d||(d[p.agent]=g)}),d},[o]);return{filteredOrders:r,filteredUnpaid:s,filteredPaid:o,stats:a,agentFirstIndex:l,paidAgentFirstIndex:u}}function jv(){const[n,e]=V.useState(null),t=V.useCallback(s=>{e(s)},[]),r=V.useCallback(()=>{e(null)},[]);return{toast:n,notify:t,hideToast:r}}const Bv="Toast-module__toast___FLdHz",$v={toast:Bv},Nh=V.memo(({message:n,onClose:e})=>(V.useEffect(()=>{const t=setTimeout(e,2e3);return()=>clearTimeout(t)},[e]),v.jsx("div",{className:$v.toast,children:n})));Nh.displayName="Toast";const qv="OrderForm-module__form___qdAdW",zv="OrderForm-module__title___dl6ju",Wv="OrderForm-module__grid___DYyIt",Gv="OrderForm-module__grid2___akE4T",Hv="OrderForm-module__label___vLfkw",Kv="OrderForm-module__input___940nH",Qv="OrderForm-module__inputError___7ksAa",Xv="OrderForm-module__error___poWSm",Yv="OrderForm-module__checkboxContainer___Saj1-",Jv="OrderForm-module__checkboxLabel___WQDa2",Zv="OrderForm-module__dateRow___-QvaB",eE="OrderForm-module__dateInput___FcTgS",tE="OrderForm-module__hint___Mx0Dv",nE="OrderForm-module__actions___Z4N06",rE="OrderForm-module__btnPrimary___B7LvR",sE="OrderForm-module__btnGhost___dE22k",re={form:qv,title:zv,grid:Wv,grid2:Gv,label:Hv,input:Kv,inputError:Qv,error:Xv,checkboxContainer:Yv,checkboxLabel:Jv,dateRow:Zv,dateInput:eE,hint:tE,actions:nE,btnPrimary:rE,btnGhost:sE},Dh=V.memo(({onSubmit:n,onClose:e,existingIds:t})=>{const[r,s]=V.useState(Qa),[o,a]=V.useState({}),l=V.useCallback((d,p)=>{s(g=>({...g,[d]:p})),d in o&&a(g=>({...g,[d]:void 0}))},[o]),u=V.useCallback(()=>{const d=xv(r.id);if(!d.valid){a(g=>({...g,id:d.message}));return}if(t.includes(r.id.trim())){a(g=>({...g,id:"订单号已存在"}));return}const p=Lv(r.amount);if(!p.valid){a(g=>({...g,amount:p.message}));return}n({id:r.id.trim(),amount:Number(r.amount),agent:r.agent,received:r.received,receiveDate:r.received?r.receiveDate||Wt():"",entryDate:Wt(),remark:r.remark,paid:!1,paidDate:null}),s(Qa),a({}),e()},[r,t,n,e]);return v.jsxs("div",{className:re.form,children:[v.jsx("div",{className:re.title,children:"新增订单"}),v.jsxs("div",{className:re.grid,children:[v.jsxs("div",{children:[v.jsx("div",{className:re.label,children:"订单号"}),v.jsx("input",{className:`${re.input} ${o.id?re.inputError:""}`,placeholder:"260418-XXXXXXXXXXXXXXX",value:r.id,onChange:d=>l("id",d.target.value)}),o.id&&v.jsx("div",{className:re.error,children:o.id})]}),v.jsxs("div",{children:[v.jsx("div",{className:re.label,children:"金额（¥）"}),v.jsx("input",{className:`${re.input} ${o.amount?re.inputError:""}`,type:"number",placeholder:"170",value:r.amount,onChange:d=>l("amount",d.target.value)}),o.amount&&v.jsx("div",{className:re.error,children:o.amount})]}),v.jsxs("div",{children:[v.jsx("div",{className:re.label,children:"客服"}),v.jsx("select",{className:re.input,value:r.agent,onChange:d=>l("agent",d.target.value),children:vl.map(d=>v.jsx("option",{children:d},d))})]})]}),v.jsxs("div",{className:re.grid2,children:[v.jsxs("div",{children:[v.jsx("div",{className:re.label,children:"备注（房子名称等）"}),v.jsx("input",{className:re.input,placeholder:"如：万科翡翠山 A栋",value:r.remark,onChange:d=>l("remark",d.target.value)})]}),v.jsx("div",{className:re.checkboxContainer,children:v.jsxs("label",{className:re.checkboxLabel,children:[v.jsx("input",{type:"checkbox",checked:r.received,onChange:d=>l("received",d.target.checked)}),"已收货"]})})]}),r.received&&v.jsxs("div",{className:re.dateRow,children:[v.jsx("span",{className:re.label,children:"收货日期"}),v.jsx("input",{className:re.dateInput,type:"date",value:r.receiveDate,onChange:d=>l("receiveDate",d.target.value)})]}),v.jsxs("div",{className:re.hint,children:["录入日期将自动记录为今天：",Wt()]}),v.jsxs("div",{className:re.actions,children:[v.jsx("button",{className:re.btnPrimary,onClick:u,children:"确认添加"}),v.jsx("button",{className:re.btnGhost,onClick:e,children:"取消"})]})]})});Dh.displayName="OrderForm";const iE="StatusBadge-module__container___MFHY9",oE="StatusBadge-module__paid___EbkKZ",aE="StatusBadge-module__received___k-Fcv",cE="StatusBadge-module__pending___MD6U-",lE="StatusBadge-module__settleable___lgOCE",Zn={container:iE,paid:oE,received:aE,pending:cE,settleable:lE},Vh=V.memo(({order:n})=>{if(n.paid)return v.jsx("span",{className:Zn.paid,children:"已收款"});if(n.received){const e=kh(n);return v.jsxs("div",{className:Zn.container,children:[v.jsx("span",{className:Zn.received,children:"已收货"}),e&&v.jsx("span",{className:Zn.settleable,children:"✦ 可结算"})]})}return v.jsx("span",{className:Zn.pending,children:"未收货"})});Vh.displayName="StatusBadge";const uE="RemarkCell-module__editContainer___HHFi1",hE="RemarkCell-module__input___4KraE",dE="RemarkCell-module__saveBtn___b7Qn2",fE="RemarkCell-module__cancelBtn___v5KBh",pE="RemarkCell-module__display___uB0Kh",er={editContainer:uE,input:hE,saveBtn:dE,cancelBtn:fE,display:pE},Oh=V.memo(({value:n,onSave:e})=>{const[t,r]=V.useState(!1),[s,o]=V.useState(n||""),a=V.useCallback(()=>{e(s),r(!1)},[s,e]),l=V.useCallback(d=>{d.key==="Enter"&&a(),d.key==="Escape"&&r(!1)},[a]),u=V.useCallback(()=>{o(n||""),r(!0)},[n]);return t?v.jsxs("div",{className:er.editContainer,children:[v.jsx("input",{autoFocus:!0,value:s,onChange:d=>o(d.target.value),onKeyDown:l,className:er.input}),v.jsx("button",{onClick:a,className:er.saveBtn,children:"✓"}),v.jsx("button",{onClick:()=>r(!1),className:er.cancelBtn,children:"✕"})]}):v.jsx("div",{onClick:u,title:"点击编辑备注",className:er.display,children:n||"添加备注…"})});Oh.displayName="RemarkCell";const mE="OrderRow-module__row___udPZW",_E="OrderRow-module__groupRow___Zv9Q9",gE="OrderRow-module__cell___fBCcW",yE="OrderRow-module__checkbox___iRa35",vE="OrderRow-module__agentName___o-1F1",EE="OrderRow-module__agentCount___myAPo",IE="OrderRow-module__indent___sqViW",TE="OrderRow-module__orderId___TSi6f",wE="OrderRow-module__amount___FOtLD",AE="OrderRow-module__date___IvGVN",RE="OrderRow-module__entryDate___R3lRm",bE="OrderRow-module__history___GNgho",SE="OrderRow-module__actions___uwRKy",PE="OrderRow-module__btnGhost___eIhAA",CE="OrderRow-module__btnPaid___ckdCv",kE="OrderRow-module__btnDanger___-DvgM",he={row:mE,groupRow:_E,cell:gE,checkbox:yE,agentName:vE,agentCount:EE,indent:IE,orderId:TE,amount:wE,date:AE,entryDate:RE,history:bE,actions:SE,btnGhost:PE,btnPaid:CE,btnDanger:kE},xh=V.memo(({order:n,isGroupStart:e,agentCount:t,isSelected:r,onSelect:s,onMarkReceived:o,onMarkPaid:a,onUpdateRemark:l,onDelete:u})=>{const d=V.useCallback(()=>{s(n.id)},[n.id,s]),p=V.useCallback(()=>{o(n.id)},[n.id,o]),g=V.useCallback(()=>{a(n.id)},[n.id,a]),w=V.useCallback(P=>{l(n.id,P)},[n.id,l]),S=V.useCallback(()=>{u(n.id)},[n.id,u]);return v.jsxs("tr",{className:`${he.row} ${e?he.groupRow:""}`,children:[v.jsx("td",{className:he.cell,children:v.jsx("input",{type:"checkbox",checked:r,onChange:d,className:he.checkbox})}),v.jsx("td",{className:he.cell,children:e?v.jsxs("div",{children:[v.jsx("div",{className:he.agentName,children:n.agent}),v.jsxs("div",{className:he.agentCount,children:[t," 单"]})]}):v.jsx("span",{className:he.indent,children:"↓"})}),v.jsx("td",{className:he.orderId,children:n.id}),v.jsxs("td",{className:he.amount,children:["¥",n.amount]}),v.jsx("td",{className:he.cell,children:v.jsx(Oh,{value:n.remark,onSave:w})}),v.jsx("td",{className:he.cell,children:v.jsx(Vh,{order:n})}),v.jsx("td",{className:he.date,children:n.receiveDate?Cs(n.receiveDate):"—"}),v.jsx("td",{className:he.date,children:n.entryDate?v.jsx("span",{className:he.entryDate,children:Cs(n.entryDate)}):v.jsx("span",{className:he.history,children:"历史"})}),v.jsx("td",{className:he.cell,children:v.jsxs("div",{className:he.actions,children:[!n.received&&v.jsx("button",{className:he.btnGhost,onClick:p,children:"确认收货"}),n.received&&!n.paid&&v.jsx("button",{className:he.btnPaid,onClick:g,children:"确认收款"}),v.jsx("button",{className:he.btnDanger,onClick:S,children:"删除"})]})})]})});xh.displayName="OrderRow";const NE="StatsCard-module__card___KGiVf",DE="StatsCard-module__label___ZxnJS",VE="StatsCard-module__value___tfHwR",Pi={card:NE,label:DE,value:VE},Lh=V.memo(({stats:n})=>{const e=n.bg==="#1a1a1a";return v.jsxs("div",{className:Pi.card,style:{background:n.bg,borderColor:n.border},children:[v.jsx("div",{className:Pi.label,style:{color:e?"#666":"#aaa"},children:n.label}),v.jsx("div",{className:Pi.value,style:{color:n.color},children:n.value})]})});Lh.displayName="StatsCard";const OE="PaidOrdersSection-module__section___6TiW-",xE="PaidOrdersSection-module__header___1bgFZ",LE="PaidOrdersSection-module__headerLeft___uh6SZ",ME="PaidOrdersSection-module__title___roxwF",FE="PaidOrdersSection-module__badge___xDZwe",UE="PaidOrdersSection-module__arrow___MC-ka",jE="PaidOrdersSection-module__content___TqdJc",BE="PaidOrdersSection-module__table___u0pCg",$E="PaidOrdersSection-module__th___E-fe1",qE="PaidOrdersSection-module__row___W-xVd",zE="PaidOrdersSection-module__td___e77Or",WE="PaidOrdersSection-module__agentName___-0tSy",GE="PaidOrdersSection-module__agentCount___69NgG",HE="PaidOrdersSection-module__indent___IxoIY",KE="PaidOrdersSection-module__orderId___kByTX",QE="PaidOrdersSection-module__amount___gz7lb",XE="PaidOrdersSection-module__noRemark___VzxA3",YE="PaidOrdersSection-module__date___Gn7QH",JE="PaidOrdersSection-module__paidDate___gNB9y",ZE="PaidOrdersSection-module__empty___1mnSc",eI="PaidOrdersSection-module__btnDanger___J7I-a",ae={section:OE,header:xE,headerLeft:LE,title:ME,badge:FE,arrow:UE,content:jE,table:BE,th:$E,row:qE,td:zE,agentName:WE,agentCount:GE,indent:HE,orderId:KE,amount:QE,noRemark:XE,date:YE,paidDate:JE,empty:ZE,btnDanger:eI},Mh=V.memo(({orders:n,agentFirstIndex:e,onDelete:t})=>{const[r,s]=_l.useState(!1),o=n.reduce((l,u)=>l+u.amount,0),a=V.useCallback(l=>{t(l)},[t]);return v.jsxs("div",{className:ae.section,children:[v.jsxs("div",{className:ae.header,onClick:()=>s(l=>!l),children:[v.jsxs("div",{className:ae.headerLeft,children:[v.jsx("span",{className:ae.title,children:"已收款订单"}),v.jsxs("span",{className:ae.badge,children:[n.length," 单 · ¥",o.toLocaleString()]})]}),v.jsx("span",{className:ae.arrow,style:{transform:r?"rotate(180deg)":"rotate(0deg)"},children:"▾"})]}),r&&v.jsx("div",{className:ae.content,children:v.jsxs("table",{className:ae.table,children:[v.jsx("thead",{children:v.jsx("tr",{children:["客服","订单号","金额","备注","收货日期","收款日期","操作"].map(l=>v.jsx("th",{className:ae.th,children:l},l))})}),v.jsx("tbody",{children:n.length===0?v.jsx("tr",{children:v.jsx("td",{colSpan:7,className:ae.empty,children:"暂无已收款订单"})}):n.map((l,u)=>{const d=e[l.agent]===u,p=n.filter(g=>g.agent===l.agent).length;return v.jsxs("tr",{className:ae.row,children:[v.jsx("td",{className:ae.td,children:d?v.jsxs("div",{children:[v.jsx("div",{className:ae.agentName,children:l.agent}),v.jsxs("div",{className:ae.agentCount,children:[p," 单"]})]}):v.jsx("span",{className:ae.indent,children:"↓"})}),v.jsx("td",{className:ae.orderId,children:l.id}),v.jsxs("td",{className:ae.amount,children:["¥",l.amount]}),v.jsx("td",{className:ae.td,children:l.remark||v.jsx("span",{className:ae.noRemark,children:"—"})}),v.jsx("td",{className:ae.date,children:l.receiveDate?Cs(l.receiveDate):"—"}),v.jsx("td",{className:ae.paidDate,children:l.paidDate?Cs(l.paidDate):"—"}),v.jsx("td",{className:ae.td,children:v.jsx("button",{className:ae.btnDanger,onClick:()=>a(l.id),children:"删除"})})]},l.id)})})]})})]})});Mh.displayName="PaidOrdersSection";const tI="InstallPrompt-module__container___zgP6A",nI="InstallPrompt-module__prompt___XA9zt",rI="InstallPrompt-module__installed___jRhkB",sI="InstallPrompt-module__offline___lYLiA",iI="InstallPrompt-module__icon___QxhrQ",oI="InstallPrompt-module__content___iV3rk",aI="InstallPrompt-module__title___uc9XD",cI="InstallPrompt-module__desc___5Dylf",lI="InstallPrompt-module__actions___NtXtX",uI="InstallPrompt-module__installBtn___03SP8",hI="InstallPrompt-module__dismissBtn___jSj1r",dI="InstallPrompt-module__closeBtn___3pCYV",oe={container:tI,prompt:nI,installed:rI,offline:sI,icon:iI,content:oI,title:aI,desc:cI,actions:lI,installBtn:uI,dismissBtn:hI,closeBtn:dI},Fh=V.memo(({isVisible:n,isInstallable:e,isInstalled:t,isOffline:r,onInstall:s,onDismiss:o})=>n?t?v.jsx("div",{className:oe.container,children:v.jsxs("div",{className:`${oe.prompt} ${oe.installed}`,children:[v.jsx("div",{className:oe.icon,children:"✓"}),v.jsxs("div",{className:oe.content,children:[v.jsx("div",{className:oe.title,children:"应用已安装"}),v.jsx("div",{className:oe.desc,children:"您可以从主屏幕快速访问订单管理"})]}),v.jsx("button",{className:oe.closeBtn,onClick:o,children:"✕"})]})}):r?v.jsx("div",{className:oe.container,children:v.jsxs("div",{className:`${oe.prompt} ${oe.offline}`,children:[v.jsx("div",{className:oe.icon,children:"📡"}),v.jsxs("div",{className:oe.content,children:[v.jsx("div",{className:oe.title,children:"离线模式"}),v.jsx("div",{className:oe.desc,children:"您正在离线使用，数据将保存在本地"})]})]})}):e?v.jsx("div",{className:oe.container,children:v.jsxs("div",{className:oe.prompt,children:[v.jsx("div",{className:oe.icon,children:"📱"}),v.jsxs("div",{className:oe.content,children:[v.jsx("div",{className:oe.title,children:"添加到主屏幕"}),v.jsx("div",{className:oe.desc,children:"安装后像 App 一样使用，离线也能访问"})]}),v.jsxs("div",{className:oe.actions,children:[v.jsx("button",{className:oe.installBtn,onClick:s,children:"安装"}),v.jsx("button",{className:oe.dismissBtn,onClick:o,children:"稍后"})]})]})}):null:null);Fh.displayName="InstallPrompt";const fI="AuthForm-module__container___dipm9",pI="AuthForm-module__card___zCPey",mI="AuthForm-module__header___T3m2B",_I="AuthForm-module__title___L4eK-",gI="AuthForm-module__subtitle___5gZRt",yI="AuthForm-module__form___Ry1iO",vI="AuthForm-module__field___cnbtJ",EI="AuthForm-module__label___Kwv8E",II="AuthForm-module__input___OhFTr",TI="AuthForm-module__error___btaoz",wI="AuthForm-module__submitBtn___1Z2oX",AI="AuthForm-module__footer___zmVTj",RI="AuthForm-module__footerText___8z8mv",bI="AuthForm-module__switchBtn___xA3aH",SI="AuthForm-module__hint___-FXdv",de={container:fI,card:pI,header:mI,title:_I,subtitle:gI,form:yI,field:vI,label:EI,input:II,error:TI,submitBtn:wI,footer:AI,footerText:RI,switchBtn:bI,hint:SI},Uh=V.memo(({onLogin:n,onRegister:e,loading:t,error:r,clearError:s})=>{const[o,a]=V.useState(!1),[l,u]=V.useState(""),[d,p]=V.useState(""),[g,w]=V.useState(""),[S,P]=V.useState(""),N=async x=>{if(x.preventDefault(),s(),P(""),!l.trim()){P("请输入邮箱");return}if(!d){P("请输入密码");return}if(d.length<6){P("密码至少6位");return}if(o){if(d!==g){P("两次密码不一致");return}await e(l.trim(),d)}else await n(l.trim(),d)},D=()=>{a(!o),P(""),s()},U=S||r;return v.jsx("div",{className:de.container,children:v.jsxs("div",{className:de.card,children:[v.jsxs("div",{className:de.header,children:[v.jsx("h1",{className:de.title,children:"订单管理系统"}),v.jsx("p",{className:de.subtitle,children:o?"创建账号，开启云端同步":"登录账号，同步您的数据"})]}),v.jsxs("form",{onSubmit:N,className:de.form,children:[v.jsxs("div",{className:de.field,children:[v.jsx("label",{className:de.label,children:"邮箱"}),v.jsx("input",{type:"email",className:de.input,placeholder:"your@email.com",value:l,onChange:x=>u(x.target.value),disabled:t})]}),v.jsxs("div",{className:de.field,children:[v.jsx("label",{className:de.label,children:"密码"}),v.jsx("input",{type:"password",className:de.input,placeholder:"至少6位密码",value:d,onChange:x=>p(x.target.value),disabled:t})]}),o&&v.jsxs("div",{className:de.field,children:[v.jsx("label",{className:de.label,children:"确认密码"}),v.jsx("input",{type:"password",className:de.input,placeholder:"再次输入密码",value:g,onChange:x=>w(x.target.value),disabled:t})]}),U&&v.jsx("div",{className:de.error,children:U}),v.jsx("button",{type:"submit",className:de.submitBtn,disabled:t,children:t?"处理中...":o?"注册":"登录"})]}),v.jsxs("div",{className:de.footer,children:[v.jsx("span",{className:de.footerText,children:o?"已有账号？":"没有账号？"}),v.jsx("button",{type:"button",className:de.switchBtn,onClick:D,children:o?"立即登录":"立即注册"})]}),v.jsxs("div",{className:de.hint,children:[v.jsx("p",{children:"💡 注册后可在多设备间同步数据"}),v.jsx("p",{children:"🔒 数据安全存储在云端"})]})]})})});Uh.displayName="AuthForm";const PI="UserInfo-module__container___F2PW5",CI="UserInfo-module__info___MQLet",kI="UserInfo-module__avatar___HuFlI",NI="UserInfo-module__details___QViyI",DI="UserInfo-module__email___JQcvd",VI="UserInfo-module__syncing___B0ZWb",OI="UserInfo-module__logoutBtn___RXq6G",Ut={container:PI,info:CI,avatar:kI,details:NI,email:DI,syncing:VI,logoutBtn:OI},jh=V.memo(({email:n,onLogout:e,syncing:t})=>v.jsxs("div",{className:Ut.container,children:[v.jsxs("div",{className:Ut.info,children:[v.jsx("div",{className:Ut.avatar,children:n.charAt(0).toUpperCase()}),v.jsxs("div",{className:Ut.details,children:[v.jsx("div",{className:Ut.email,children:n}),t&&v.jsx("div",{className:Ut.syncing,children:"同步中..."})]})]}),v.jsx("button",{className:Ut.logoutBtn,onClick:e,children:"退出登录"})]}));jh.displayName="UserInfo";const xI="App-module__container___7v2Yg",LI="App-module__content___KyCTW",MI="App-module__btnPrimary___CjPav",FI="App-module__btnGhost___Ipnwx",UI="App-module__btnGreen___MeOim",jI="App-module__btnDanger___IobJ-",BI="App-module__input___-D9Bz",$I="App-module__tab___OY-In",qI="App-module__tabActive___PxvTA",zI="App-module__saveBadge___VPhG2",WI="App-module__table___PYfsX",GI="App-module__tableHeader___3nN-g",HI="App-module__statsGrid___y4zF-",KI="App-module__header___DVhBb",QI="App-module__headerSubtitle___OKyxa",XI="App-module__headerTitle___-BLPn",YI="App-module__headerActions___BJmv2",JI="App-module__filterBar___BPNDq",ZI="App-module__filterTabs___r6kLy",eT="App-module__tableContainer___l7LMN",tT="App-module__footer___oi28L",nT="App-module__footerInfo___ohuNi",rT="App-module__emptyState___vXMa1",sT="App-module__batchBar___H6lfE",iT="App-module__batchInfo___J6Y6h",oT="App-module__batchActions___RolMz",aT="App-module__checkbox___j2xuN",X={container:xI,content:LI,btnPrimary:MI,btnGhost:FI,btnGreen:UI,btnDanger:jI,input:BI,tab:$I,tabActive:qI,saveBadge:zI,table:WI,tableHeader:GI,statsGrid:HI,header:KI,headerSubtitle:QI,headerTitle:XI,headerActions:YI,filterBar:JI,filterTabs:ZI,tableContainer:eT,footer:tT,footerInfo:nT,emptyState:rT,batchBar:sT,batchInfo:iT,batchActions:oT,checkbox:aT};function cT(){const{loading:n,error:e,login:t,register:r,logout:s,clearError:o,isLoggedIn:a,userId:l,displayName:u}=Vv(),{orders:d,syncState:p,addOrder:g,markReceived:w,markPaid:S,updateRemark:P,deleteOrder:N,batchDelete:D}=Ov(l),{toast:U,notify:x,hideToast:G}=jv(),{isInstallable:Z,isInstalled:ie,isOffline:te,promptInstall:T}=wd(),[m,y]=V.useState(!0),[E,I]=V.useState(!1),[R,_]=V.useState("all"),[$e,Dt]=V.useState(""),[Oe,Ue]=V.useState(new Set),{filteredUnpaid:xe,filteredPaid:Nn,stats:He,agentFirstIndex:Hs,paidAgentFirstIndex:Ke}=Uv(d,R,$e),ye=V.useMemo(()=>[{label:"订单总数",value:`${He.totalOrders} 单`,color:"#1a1a1a",bg:"#fff",border:"#e8e4de"},{label:"订单总金额",value:`¥${He.totalAmount.toLocaleString()}`,color:"#1a1a1a",bg:"#fff",border:"#e8e4de"},{label:"待收款金额",value:`¥${He.receivedAmount.toLocaleString()}`,color:"#065f46",bg:"#fff",border:"#e8e4de"},{label:`本次可结算 (${He.nextDateStr})`,value:`¥${He.settleableAmount.toLocaleString()}`,color:"#fff",bg:"#1a1a1a",border:"#1a1a1a"},{label:"累计已收款",value:`¥${He.paidAmount.toLocaleString()}`,color:"#5b21b6",bg:"#f5f3ff",border:"#ddd6fe"}],[He]),Ks=V.useCallback(async(B,ue)=>{await t(B,ue),x("✅ 登录成功")},[t,x]),Vt=V.useCallback(async(B,ue)=>{await r(B,ue),x("✅ 注册成功")},[r,x]),Qs=V.useCallback(async()=>{await s(),x("已退出登录")},[s,x]),tn=V.useCallback(async B=>{await g(B),x("✅ 订单已添加")},[g,x]),Xs=V.useCallback(async B=>{await w(B,Wt()),x("✅ 已标记收货")},[w,x]),Ys=V.useCallback(async B=>{await S(B,Wt()),x("💰 已标记收款")},[S,x]),nn=V.useCallback(async(B,ue)=>{await P(B,ue),x("✅ 备注已保存")},[P,x]),Ot=V.useCallback(async B=>{await N(B),x("🗑 订单已删除"),Ue(ue=>{const Ne=new Set(ue);return Ne.delete(B),Ne})},[N,x]),Dn=V.useCallback(()=>{Fv(d),x("📥 CSV 文件已导出")},[d,x]),Vn=V.useCallback(B=>{Ue(ue=>{const Ne=new Set(ue);return Ne.has(B)?Ne.delete(B):Ne.add(B),Ne})},[]),On=V.useCallback(()=>{Oe.size===xe.length?Ue(new Set):Ue(new Set(xe.map(B=>B.id)))},[Oe.size,xe]),xn=V.useCallback(async()=>{Oe.size!==0&&(await D(Array.from(Oe)),x(`🗑 已删除 ${Oe.size} 个订单`),Ue(new Set))},[Oe,D,x]),Lr=V.useCallback(async()=>{const B=Array.from(Oe).filter(ue=>{const Ne=d.find(Ln=>Ln.id===ue);return Ne&&!Ne.received});if(B.length===0){x("没有可标记收货的订单");return}for(const ue of B)await w(ue,Wt());x(`✅ 已标记 ${B.length} 个订单收货`),Ue(new Set)},[Oe,d,w,x]);return n?v.jsx("div",{className:X.container,children:v.jsx("div",{className:X.loading,children:"加载中..."})}):a?v.jsxs("div",{className:X.container,children:[v.jsx("style",{children:`
        @import url('https://fonts.googleapis.com/css2?family=Noto+Serif+SC:wght@400;600;700&display=swap');
        * { box-sizing: border-box; }
        input, select { font-family: inherit; }
      `}),v.jsx(Fh,{isVisible:m,isInstallable:Z,isInstalled:ie,isOffline:te,onInstall:T,onDismiss:()=>y(!1)}),U&&v.jsx(Nh,{message:U,onClose:G}),v.jsxs("div",{className:X.content,children:[v.jsx(jh,{email:u||"",onLogout:Qs,syncing:p.syncing}),v.jsxs("div",{className:X.header,children:[v.jsxs("div",{children:[v.jsx("div",{className:X.headerSubtitle,children:"订单管理系统"}),v.jsx("h1",{className:X.headerTitle,children:"收货台账"}),v.jsx("div",{style:{marginTop:6},children:v.jsx("span",{className:X.saveBadge,children:"☁️ 云端同步 · 多设备互通"})})]}),v.jsxs("div",{className:X.headerActions,children:[v.jsx("button",{className:X.btnGreen,onClick:Dn,children:"导出 CSV"}),v.jsx("button",{className:X.btnPrimary,onClick:()=>I(B=>!B),children:E?"取消":"+ 新增订单"})]})]}),v.jsx("div",{className:X.statsGrid,children:ye.map((B,ue)=>v.jsx(Lh,{stats:B},ue))}),E&&v.jsx(Dh,{onSubmit:tn,onClose:()=>I(!1),existingIds:d.map(B=>B.id)}),Oe.size>0&&v.jsxs("div",{className:X.batchBar,children:[v.jsxs("span",{className:X.batchInfo,children:["已选择 ",Oe.size," 个订单"]}),v.jsxs("div",{className:X.batchActions,children:[v.jsx("button",{className:X.btnGhost,onClick:Lr,children:"批量确认收货"}),v.jsx("button",{className:X.btnDanger,onClick:xn,children:"批量删除"}),v.jsx("button",{className:X.btnGhost,onClick:()=>Ue(new Set),children:"取消选择"})]})]}),v.jsxs("div",{className:X.filterBar,children:[v.jsx("div",{className:X.filterTabs,children:Td.map(({value:B,label:ue})=>v.jsx("button",{className:`${X.tab} ${R===B?X.tabActive:""}`,onClick:()=>_(B),children:ue},B))}),v.jsx("input",{className:X.input,style:{width:230},placeholder:"搜索订单号 / 客服 / 备注",value:$e,onChange:B=>Dt(B.target.value)})]}),v.jsx("div",{className:X.tableContainer,children:v.jsxs("table",{className:X.table,children:[v.jsx("thead",{children:v.jsxs("tr",{children:[v.jsx("th",{className:X.tableHeader,style:{width:40},children:v.jsx("input",{type:"checkbox",checked:Oe.size===xe.length&&xe.length>0,onChange:On,className:X.checkbox})}),Id.map(B=>v.jsx("th",{className:X.tableHeader,children:B},B))]})}),v.jsx("tbody",{children:xe.length===0?v.jsx("tr",{children:v.jsx("td",{colSpan:9,className:X.emptyState,children:"暂无待收款订单"})}):xe.map((B,ue)=>v.jsx(xh,{order:B,isGroupStart:Hs[B.agent]===ue,agentCount:xe.filter(Ne=>Ne.agent===B.agent).length,isSelected:Oe.has(B.id),onSelect:Vn,onMarkReceived:Xs,onMarkPaid:Ys,onUpdateRemark:nn,onDelete:Ot},B.id))})]})}),v.jsx(Mh,{orders:Nn,agentFirstIndex:Ke,onDelete:Ot}),v.jsx("div",{className:X.footer,children:v.jsxs("div",{className:X.footerInfo,children:["共 ",d.length," 条记录 · 云端实时同步"]})})]})]}):v.jsxs("div",{className:X.container,children:[v.jsx("style",{children:`
          @import url('https://fonts.googleapis.com/css2?family=Noto+Serif+SC:wght@400;600;700&display=swap');
